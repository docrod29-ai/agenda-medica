...
export const CLINICAL_ENGINE_REGISTRY: MotorClinico[] = [
  ...
  },
  {
    ...
    missingData: 'sin unidad reconocida NO compara (antes comparaba a ciegas e invertía la dirección de la alerta). Un valor CENSURADO («>400», «<50») se juzga por intervalo: si cruza el umbral, se declara no evaluable en vez de darse por normal (REG-270).',
