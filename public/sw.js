 ...
 */
const CACHE = 'nexusmed-v491'  // LABORATORIO: perdida de datos + RBAC. (1) Cargar resultados en una orden PISABA los anteriores sin rastro: una segunda carga borraba la primera — perdida de dato clinico y de trazabilidad (NOM-004). Ahora se conserva: en una transaccion (por si dos dispositivos cargan a la vez) lo que habia se empuja a historialResultados antes de escribir la nueva version, y la ficha muestra las cargas previas tachadas con quien y cuando. (2) Enfermeria y farmacia podian ESCRIBIR y BORRAR resultados de laboratorio que no emiten, sin bitacora — el permiso era solo de vista. Las reglas ahora dejan LEER a todo el staff clinico y SOLICITAR a cualquiera, pero cargar/corregir un resultado y borrar una orden queda para quien lo emite: laboratorio o medico.
