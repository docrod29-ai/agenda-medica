 ...
 */
const CACHE = 'nexusmed-v463'  // AUDITORIA MODULO 0, LOTE 3. (0) REGRESION PROPIA DE v461 CERRADA: al bloquear la firma por campo, la segunda rama del OR quedo sin isMember y CUALQUIER cuenta del mundo podia sobrescribir la config de CUALQUIER consultorio sacando el clinicId de la URL publica de reservas. Reglas redesplegadas. (1) LA NOTA DICTADA YA NO SE PIERDE: el autoguardado al servidor solo miraba resumen y secciones, nunca la transcripcion ni Dx ni medicamentos, asi que durante el dictado NUNCA disparaba; y dictar no genera actividad, asi que a los 30 min se cerraba sesion y se purgaba el respaldo local. Ahora guarda con cualquier contenido y se persiste antes de cerrar. (2) Proxy de imagenes: cache-control private (la firma ya no la guardan cachés compartidas) y SSRF real cerrada. (3) permisosPorRol(null) daba ADMIN. (4) clinic obsoleta al cambiar de consultorio.
