...
describe('E0-07 · el registro no puede MENTIR sobre el código (por MÉTODO y por ARGUMENTO)', () => {
  ...
  it('el ANALIZADOR no pasa por vacío (si se rompe, todo lo de arriba pasaría sin comprobar nada)', () => {
    ...
    // abierto.
    expect(llamadas.length).toBe(97)   // +1 el 2026-08-09: `expediente/paquete-visita`, con su POST y su `verificarCapacidad('firmar')`; +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    expect(rutasConGuardia).toBe(80)   // +1 el 2026-08-09: `expediente/paquete-visita`; +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    ...
    expect(conVocabulario).toBe(54)   // +1 el 2026-08-09: `expediente/paquete-visita`; +1 el 2026-08-04: `arco/oponerse`; +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
  })
...
describe('E0-07 · propiedad heredada de E0-06, ahora expresada en capacidades', () => {
  ...
  it('el control de que la comprobación anterior NO pasa por vacío', () => {
    ...
    // +1 el 2026-08-09 (V9 · POSTVISIT-001): `expediente/paquete-visita` LEE las
    // notas firmadas —la de la visita y la anterior, para saber qué cambió en la
    // medicación— y por eso entra. Está bajo `firmar`, que es capacidad clínica.
  ...
  it('las rutas que tocan la IDENTIDAD del paciente están congeladas (segundo nivel de PHI)', () => {
    ...
    expect(conPaciente).toEqual([
      ...
      /**
       * +1 el 2026-08-09 (V9 · POSTVISIT-001): compone y libera el paquete de la
       * visita. Toca la identidad porque lee la nota firmada del paciente y su
       * fecha de seguimiento, y ESCRIBE lo que él va a leer. Va bajo `firmar`, la
       * capacidad que lleva identidad detrás: `approvedBy` sale del token
