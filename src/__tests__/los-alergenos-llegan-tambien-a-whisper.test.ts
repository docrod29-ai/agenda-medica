...
/**
 * LOS ALÉRGENOS LLEGAN TAMBIÉN A WHISPER — REG-520.
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
...
describe('REG-520 · una lista para los cuatro puntos de envío', () => {
...
describe('REG-520 · guardián: los cuatro puntos de envío pasan por la lista, y las tres rutas la leen', () => {
