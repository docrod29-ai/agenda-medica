...
/**
 * LA MEMBRESÍA DEL SERVIDOR SE EJECUTA CONTRA UN DOBLE QUE DISTINGUE IDS — REG-526.
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
...
describe('REG-526 · verificarMiembro, ejecutado', () => {
...
describe('REG-526 · verificarCapacidad, ejecutado sobre la misma membresía', () => {
