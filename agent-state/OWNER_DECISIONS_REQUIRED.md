...
| C-6 | ¿Un «no me acuerdo» del paciente sobre un antecedente crónico debe impedir firmar? (REG-192) | **No bloquear.** Hoy sale como aviso ámbar: ni negado ni confirmado, falta el dato | Que la duda pase de aviso a compuerta de firma | El aviso ya sale en el panel NER y en la barra de la consulta |
