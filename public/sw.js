 ...
 */
const CACHE = 'nexusmed-v466'  // MODULO 1 (expediente), LOTE 1 — lo que puede danar a un paciente o perder la consulta. (1) LA NOTA INVENTABA LA ALERGIA: rellenaba severidad 'moderada' y confirmada true desde un texto libre, asi que una ANAFILAXIA dictada quedaba registrada como moderada y la nota firmada afirmaba una confirmacion inexistente; el tipo obligaba a rellenar, y un tipo que obliga a rellenar obliga a inventar. (2) CAPRINI IGNORABA LA NEGACION: 'niega varices, niega fractura de cadera' marcaba AMBAS presentes, ~+6 puntos y tromboprofilaxis en quien las nego. (3) Un lote de transcripcion que fallaba se descartaba en silencio Y se borraba el audio que lo respaldaba. (4) Grabar por 2a vez BORRABA el dictado anterior. (5) Nota firmada decia 'Agregado a la nota' sin guardar nada. (6) Imposible teclear 70.5 de peso. (7) Cualquiera que se registrara usaba la API key del dueno sin medidor. (8) El nombre del paciente viajaba a Anthropic sin aportar nada.
