...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **216 REG** con causa raíz |
| Invariantes sellados | **378 archivos, 5461 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 216 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 216 defectos documentados con
