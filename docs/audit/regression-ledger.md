...
## REG-201 — «no padece diabetes» era un antecedente positivo (v1083)

> **Por qué el número salta de 192 a 201.** Esta reparación nació como REG-195 /
> v1077 y los dos estaban tomados por otra rama. Es **T-1**: la rutina nocturna
> arranca de `main` en cada firing, ~20 ramas conviven y muchas reclaman el mismo
> número. El 201 / v1083 se lo asignó la rama `agent/safety/SAFE-003` al coordinar
> la renumeración de su cadena; se conserva **el mismo** aquí para que, se fusione
> la que se fusione primero, la entrada no se duplique ni cambie de nombre. El
> hueco 193–200 lo ocupan reparaciones de otras ramas abiertas.
...
REG-199/194: aquéllos son el lado del dictado (`negaciones.ts`). Éste es el motor
