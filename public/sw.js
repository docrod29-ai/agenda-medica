 ...
 */
const CACHE = 'nexusmed-v488'  // LOTE DE AUDITORIA: 6 defectos graves. (1) LABORATORIO EN EL PACIENTE EQUIVOCADO: el import FHIR nunca leia el subject del Bundle y archivaba los resultados en el paciente de la PANTALLA. Pegar el Bundle de otro por tener la pestana equivocada metia sus labs en este expediente, con mensaje verde. Ahora se verifica y si no coincide se BLOQUEA. (2) NINGUN RECORDATORIO DE WHATSAPP SALIA NUNCA: el cron corria 13:00 UTC = 07:00 MX y el silencio por defecto es 21:00-08:00, asi que todo se descartaba; ademas una sola pasada diaria nunca caia en la ventana del recordatorio del mismo dia. Ahora corre cada hora de 08:00 a 20:00 MX. (3) UN ANTICIPO DE PACIENTE REESCRIBIA EL PLAN DE LA CLINICA: el pago unico caia en la rama de suscripcion y activaba plan clinica con subscriptionId vacio; y ese dinero no generaba cobro, no existia en ningun corte y se cobraba dos veces. (4) ENUMERACION PUBLICA de clinic_review_requests: read cubre list, cualquiera sin sesion podia listar nombres de pacientes y sus medicos de TODAS las clinicas. (5) NOTAS INTERNAS del consultorio viajaban al portal del paciente en el JSON crudo. (6) CAMAS: el cruce censo-inventario era === exacto sobre texto libre, 302 A no casaba 302-A y la cama salia LIBRE con el paciente dentro. Tokens de resena pasan a aleatoriedad criptografica.
