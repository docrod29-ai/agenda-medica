#!/usr/bin/env node
/**
 * MIRAR LA RECETA CON EL EXPEDIENTE DETRÁS — REG-517 · 520 · 521.
 *
 ...
 *   · la creatinina del expediente con su fecha y la marca de caducidad (REG-520);
 *   · la interacción con la warfarina VIGENTE y «ya existía antes de hoy» no
 *     (la introduce el ketorolaco de hoy) (REG-520);
 *   · «Paracetamol aparece 2 veces» con la suma contra el techo (REG-521).
 *
...
const ESPERADO = [
  ...
  /* REG-530: la nota que se imprime NO puede contarse como «ya lo toma». */
