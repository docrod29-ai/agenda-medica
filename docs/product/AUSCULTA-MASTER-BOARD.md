...
| Casos declarados en el árbol | **12987** en 1091 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **581 archivos · 7989 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-652** | `docs/audit/regression-ledger.md` |
