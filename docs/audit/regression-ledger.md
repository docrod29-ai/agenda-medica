...
## REG-309 — `/api/portal`, `/api/public/resena` y `/api/payment/create-checkout` sin límite de tasa

**Renumerado de REG-306 a REG-309 al fusionar** (9-ago-2026): dos ramas
independientes tomaron el mismo siguiente-REG-libre desde `main` sin verse
entre sí — el problema T-1 que ya documenta `agent-state/OWNER_DECISIONS_REQUIRED.md`.
`main` se quedó con el REG-306 real (el medidor del teléfono, arriba).
Contenido sin otro cambio.
