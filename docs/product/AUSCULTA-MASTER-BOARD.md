...
| **P1-6** | Las alergias están duplicadas en `Patient` y `ResumenClinicoPaciente`; producción lee la ubicación vieja, así que **recepción puede leer alergias**. | `types/index.ts:250,352` |
