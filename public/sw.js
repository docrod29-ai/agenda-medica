 ...
 */
const CACHE = 'nexusmed-v480'  // EL ANTIBIOGRAMA YA VIVE EN LA CONSULTA. Era una pantalla aparte, asi que su conclusion —fenotipo, mecanismo, terapia dirigida, aislamiento, alertas— habia que reescribirla A MANO en la nota; para un infectologo es la herramienta cuyo resultado mas veces tiene que quedar en el expediente. Ahora es una herramienta mas de la consulta y se agrega de un clic, con el PANEL incluido: sin el, la nota afirmaria un mecanismo de resistencia sin el dato que lo sustenta. Ademas el panel cardiometabolico ya muestra apoB, no-HDL y colesterol remanente con su interpretacion, fundamento y recomendaciones, senala las DISCORDANCIAS con el LDL-C y dice que estudios conviene solicitar — todo agregable a la nota.
