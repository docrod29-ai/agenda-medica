...
| 4 | `POSTVISIT-001` | ✅ **cerrada** | `67ab2a5a` |
...
> **Cerrados el 9-ago-2026 con `POSTVISIT-001`**: `POSTVISIT-GATE-001` (REG-306)
> y `POSTVISIT-ENTREGA-001` (REG-307). Quedan tres P1 y el P0 de teleconsulta.
