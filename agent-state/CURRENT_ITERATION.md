...
**Unidad actual**: `POSTVISIT-001` ✅ **CERRADA** (9-ago, REG-306/307) →
siguiente: **`PATIENT-AI-001`** (ASK NEXUS: cinco clases de respuesta, jerarquía
de fuentes y las doce pruebas de equipo rojo del §0 de la especificación como
fixture permanente). Cerradas antes: `PATIENT-UX-TRUTH-001`, los tres P0 de
