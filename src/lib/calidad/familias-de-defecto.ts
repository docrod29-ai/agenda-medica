...
export const FAMILIAS: readonly FamiliaDeDefecto[] = [
  {
    ...
    regs: [154, 160, 164, 167, 169, 170, 182, 188, 198, 218, 221, 222, 225, 230, 232, 236, 238, 239, 244, 249, 252, 256, 257, 258, 259, 261, 262, 264, 266, 268, 288, 290, 291, 292, 293],
  },
  {
    clave: 'se_contradice',
    ...
    regs: [171, 179, 180, 189, 191, 194, 196, 199, 214, 217, 223, 226, 229, 234, 269, 270, 272, 273, 277, 278, 279, 285, 286, 294, 295],
  },
  {
    clave: 'habla_real',
  ...
  },
  {
    ...
    patron:
      ...
      'lo demás.',
    regs: [157, 193, 195, 215, 216, 219, 283, 287],
  },
  {
    clave: 'tarde',
