...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **156 REG** con causa raíz |
| Invariantes sellados | **317 archivos, 4523 casos** que no pueden encoger |
| Suite completa | **8591 pruebas** en verde, en CI |
...
✅ El `regression-ledger` **es** el historial: 156 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 156 defectos documentados con
...
**Fuerte**: seguridad documentada, aislamiento probado en CI, 8591 pruebas,
