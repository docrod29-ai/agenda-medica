...
|---|---|---|---|---|
| RTC-05 | P1 | RT-06 + ORT-14 | Dos FAB permanentes (ayuda 52px estilo Intercom + tema 44px) sobre TODA pantalla clínica; no suscritos a `EVENTO_GRABANDO`; en móvil ocluyen contenido en 4/6 superficies; glassmorphism en el toggle; parches por-pantalla con números mágicos | Tema a Operaciones en móvil; ayuda fuera del arco del pulgar; la compuerta compartida YA EXISTE (`@/hooks/useGrabando`, RTC-04) — consumirla, no copiarla |
