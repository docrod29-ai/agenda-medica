...
const ESPECIFICO: Partial<Record<TipoNota, string>> = {
  ...
  evolucion_uci: `Nota de evolución de UCI ORGANIZADA POR APARATOS Y SISTEMAS (cabeza a pies). La fuente es una DISCUSIÓN de pase de visita (médico adscrito, residentes, enfermería) — integra lo relevante de todos, atribuyendo decisiones al adscrito. Organiza en: contexto/objetivos del día, neurológico (Glasgow/RASS/CAM-ICU/sedación), respiratorio (modo/FiO2/VT/PEEP/Pplateau/gasometría), hemodinámico (PAM/vasopresores con dosis y unidad/lactato/perfusión), renal-metabólico (balance/electrolitos/ácido-base/KDIGO), gastrointestinal-nutrición, hematológico-infeccioso (día de antibiótico/cultivos/susceptibilidad), piel-dispositivos, y plan por sistema.
