...
import { revisarDosis, revisarUnidadDosis, extraerMg, extraerTomasDia, esDosisPorKg, filtrarAlertasParaMostrar, type AlertaDosis } from '@/lib/seguridad/dosis'
  ...
  const alertasDosis = useMemo(() => {
    ...
    for (const m of medicamentos) {
      ...
      const dosisPrescrita = esDosisPorKg(m.dosis)
        ...
        : cantidad(mg, 'mg', 'masa')
      const al = filtrarAlertasParaMostrar(
