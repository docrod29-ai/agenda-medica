 ...
 * ── DE DÓNDE SALE ────────────────────────────────────────────────────────────
 *
 * `docs/audit/regression-ledger.md` tiene 53 defectos con su causa raíz. Leídos
 * de uno en uno son 53 historias. Contados por familia dicen algo que ninguno
 ...
 *
 * Porque una tabla escrita a mano envejece en silencio: el REG-206 aterriza, la
 * tabla sigue diciendo 53 cuando ya son 54, y nadie se entera. Aquí el guardián compara este
