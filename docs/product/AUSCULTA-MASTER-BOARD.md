...
| Casos declarados en el árbol | **13332** en 1124 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **616 archivos · 8351 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-685** | `docs/audit/regression-ledger.md` |
