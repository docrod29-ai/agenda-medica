...
| Pregunta con `escalada == true` ⇒ existe `tareas_clinicas/pregunta__{id}` | Sin ella, la escalación sólo vive en un WhatsApp que quizá no salió (REG-514) | Reparado el 5-sep-2026; **se comprueba desde la próxima pregunta escalada** |
