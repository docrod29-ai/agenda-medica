...
| Casos declarados en el árbol | **13263** en 1114 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **600 archivos · 8225 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-672** | `docs/audit/regression-ledger.md` |
