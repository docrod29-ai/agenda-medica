...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **64 REG** con causa raíz |
| Invariantes sellados | **241 archivos, 3669 casos** que no pueden encoger |
| Suite completa | **7441 pruebas** en verde, en CI |
...
✅ El `regression-ledger` **es** el historial: 64 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 64 defectos documentados con
...
**Fuerte**: seguridad documentada, aislamiento probado en CI, 7441 pruebas,
