    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', padding: 24 }}>
      ...
      <div className="no-print" style={{ maxWidth: 800, margin: '0 auto 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <div className="actions-row">
          ...
          <button onClick={() => imprimirElemento(document.getElementById('doc'), 'Carta de referencia', { formato: 'carta' })} style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'var(--s2)', color: 'var(--text)', border: '1px solid var(--border)', borderRadius: 10, padding: '10px 18px', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
