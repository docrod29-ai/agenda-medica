  ...
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 14, background: 'var(--s1, rgba(127,127,127,.03))', padding: '18px 20px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 4 }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 800, color: 'var(--red)', background: 'color-mix(in srgb, var(--red) 12%, transparent)', padding: '3px 9px', borderRadius: 'var(--r-pill)' }}>{alta} urgentes</span>
