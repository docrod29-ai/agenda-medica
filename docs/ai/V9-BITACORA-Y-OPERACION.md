...
| 2026-08-09 | **POSTVISIT-001** | `PENDIENTE_SHA` | El paquete se genera del encuentro y **sólo se libera con aprobación del médico**: compuerta de firma en el compositor, en la ruta y en la pantalla; `approvedBy` de la sesión; paquete inmutable con versión; la hoja llega al portal. Cierran `POSTVISIT-GATE-001` y `POSTVISIT-ENTREGA-001` | **306, 307** |
