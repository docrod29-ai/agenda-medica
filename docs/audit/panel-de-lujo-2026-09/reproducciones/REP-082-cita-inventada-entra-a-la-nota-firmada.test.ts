...
const COMPRUEBA_CITAS =
  /\b(citasEnTexto|verificarAfirmaciones|citasFueraDeLosHallazgos|citasQueDicenLoContrario)\s*\(|\\\[\(\\d/
...
describe('REP-082 · el análisis que se agrega a la nota comprueba sus citas [n] contra las referencias', () => {
  ...
  it('HOY FALLA: entre limpiarMarkdown y setSecciones se comprueban las citas [n] contra `articulos`', () => {
