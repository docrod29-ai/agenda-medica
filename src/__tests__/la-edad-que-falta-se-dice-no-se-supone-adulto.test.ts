...
/**
 * LA EDAD QUE FALTA SE DICE; NO SE SUPONE ADULTO — REG-517.
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
...
describe('REG-517 · edadParaDosificar', () => {
...
describe('REG-517 · la receta y la consulta pasan por él (comentarios fuera)', () => {
