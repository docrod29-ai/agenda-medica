 ...
 */
const CACHE = 'nexusmed-v494'  // LOTE FARMACIA + ANALITICA. FARMACIA: (1) El boton Editar reescribia las existencias desde el valor viejo del formulario, fuera del ledger: corregir el proveedor revertia en silencio cualquier dispensacion hecha en medio (stock reaparece, movimiento huerfano) — perdida de dato. Ahora editar NUNCA toca existencias; solo se mueven por + / − transaccional. (2) Dispensar un lote CADUCADO no avisaba: ahora exige confirmacion en la salida. (3) Cualquier rol (recepcion/facturacion) podia tocar el inventario y los controlados: reglas ahora exigen rol clinico, sellan el autor del movimiento y prohiben stock negativo; Farmacia sale del menu de la vista de asistente. ANALITICA: (4) La Consola y la Contabilidad del dueno mostraban DOS MRR distintos para la misma clinica (tablas de precio paralelas, 1799 vs 899, y planes que caian a 0): unificado a PLANES, la fuente unica. (5) Inyeccion de formulas CSV en export de contabilidad y de pacientes (un consultorio/paciente llamado =cmd|... se ejecutaba al abrir en Excel): blindaje central celdaSegura. (6) Precio $1,999 desincronizado en consola del dueno → derivado de PLANES.
