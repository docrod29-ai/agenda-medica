...
|---|---|---|---|---|
| V10-D1 | **Fusionar `claude/nexus-patient-ux-v9` a main** (8 commits: DESIGN-SYSTEM-001, NAVIGATION-001, PATIENT-COMPANION-001, REG-274…281). Está 48 commits detrás; necesita rebase/merge y PR | Abrir PR de esa rama y fusionarla antes de que V10 toque shell, navegación o compañero | V10 construiría encima de un main que no tiene el sistema de diseño real → trabajo duplicado o pisado | ✅ **decidida y ejecutada** — el dueño la aprobó el 9-ago; PR #279 fusionada (verificado por ancestría en `git merge-base`) |
