...
REG-291). **Cero P0 abiertos en V9.** Siguiente: `DESIGN-SYSTEM-001`.
...
| El enlace **no viajaba por WhatsApp**, que es por donde se anuncia la videoconsulta | CERRADO 9-ago (REG-291) — `PATIENT-TELE-002` |
