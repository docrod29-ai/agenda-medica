...
const DIC: Record<string, string> = {
  ...
  // Abreviaturas y términos MX frecuentes (la causa de "0 resultados" en PubMed).
  ivu: 'urinary tract infection', itu: 'urinary tract infection',
  urinaria: 'urinary', urinario: 'urinary', vejiga: 'bladder', orina: 'urine',
  cistitis: 'cystitis', pielonefritis: 'pyelonephritis', prostatitis: 'prostatitis',
  dm2: 'type 2 diabetes', dm: 'diabetes', has: 'hypertension', hta: 'hypertension',
  erc: 'chronic kidney disease', irc: 'chronic kidney disease',
  lra: 'acute kidney injury', iam: 'myocardial infarction', sica: 'acute coronary syndrome',
  icc: 'heart failure', evc: 'stroke', acv: 'stroke',
  tvp: 'deep vein thrombosis', tep: 'pulmonary embolism',
  vih: 'hiv', sida: 'aids', tb: 'tuberculosis', tbc: 'tuberculosis',
  eii: 'inflammatory bowel disease', era: 'rheumatoid arthritis', les: 'lupus',
  hemorragia: 'hemorrhage', trombosis: 'thrombosis', embolia: 'embolism',
  convulsion: 'seizure', epilepsia: 'epilepsy', migrana: 'migraine',
