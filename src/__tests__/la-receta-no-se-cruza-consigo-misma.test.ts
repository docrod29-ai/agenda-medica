 ...
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
 * REG-527 hizo que la receta cargara las notas FIRMADAS del paciente para
 ...
 * con el paciente sintético `pac-006`. Las 33 pruebas de REG-527 y REG-528
...
describe('REG-535 · la nota que se imprime no cuenta como «ya lo toma»', () => {
