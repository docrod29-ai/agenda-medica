...
- **sin versión** — EVAL-002 (número y versión SIN reclamar: 14 PR abiertos se llaman «REG-192 · v1074» y REG-204/v1085 ya lo usa el PR #253). El motor de temporalidad salió en v1027-v1030 SIN corpus: sus casos eran los que escribió quien lo escribió. Construir la vara encontró el defecto en la primera pasada, y era la trampa que el módulo tenía escrita EN SU PROPIO ENCABEZADO: «hace tres años que tiene diabetes» y «tiene diabetes hace tres años» se marcaban PASADO. Cubría «DESDE hace tres años tiene diabetes» y no las otras dos formas de decir exactamente lo mismo — que son la manera normal de contarlo en la consulta mexicana. Las dos familias fallaban al 100 %. Y del otro lado, «ya se curó» no se reconocía porque el patrón exigía el «le». Lo que decide es el tiempo del VERBO que gobierna al padecimiento, no la marca de tiempo: el control «hace tres años que TUVO neumonía» sigue siendo pasado y se pone rojo si alguien apaga la trampa mirando sólo el «hace». Corpus de 496 frases SINTÉTICAS, producto cruzado de 31 marcos × 16 padecimientos, con la etiqueta puesta por el marco ANTES de correr el motor — no pueden coincidir por construcción. Criterio CERO. Dos huecos declarados y NO reparados: «artritis» no está en CRONICAS, y ni temporalidad.ts ni negaciones.ts están en registry.ts pese a que la regla §7 lo exige. VERIFICADO que puede ponerse rojo: 4 de 8 casos fallan.
