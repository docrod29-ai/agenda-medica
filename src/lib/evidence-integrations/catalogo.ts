...
const ENTRADAS = {
  ...
  // ── LAS QUE FALTABAN (REG-389) ──────────────────────────────────────────
  //
  // El alcance canonico nombra 29 fuentes y este catalogo tenia 12. Las otras 17
  // no estaban «pendientes»: NO ESTABAN, y por eso la regla «un proveedor no
  // operativo baja pero no desaparece» nunca disparaba para ellas — el medico no
  // podia leer «DynaMed: no se consulto» porque DynaMed no existia para el
  // selector.
  //
  // Entran con su matriz SIN VERIFICAR, que es lo unico honesto: declarar una via
  // oficial o una semantica de fallo que nadie ha comprobado seria inventar la
  // ficha en vez de construirla. Lo que si se declara es POR QUE estan asi y QUE
  // DECISION falta.
  nejm: {
    id: 'nejm',
    nombre: 'NEJM',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Hoy sus articulos se DESCUBREN via PubMed (resumen y metadatos publicos). Eso no es una integracion editorial y llamarlo asi seria falso: no hay contrato, ni API, ni texto completo.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con la editorial o su API institucional. Sin eso se queda en descubrimiento via indice.',
  },
  jama: {
    id: 'jama',
    nombre: 'JAMA Network',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Igual que NEJM: descubrimiento via PubMed, sin integracion editorial.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con la editorial o acceso por su API institucional. Sin eso se queda en descubrimiento via indice.',
  },
  lancet: {
    id: 'lancet',
    nombre: 'The Lancet',
    ...
    porQue: 'Igual que NEJM: descubrimiento via PubMed, sin integracion editorial.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con Elsevier o acceso por su API institucional. Sin eso se queda en descubrimiento via indice.',
  },
  bmj: {
    id: 'bmj',
    nombre: 'The BMJ',
  ...
  cid: {
    id: 'cid',
    nombre: 'Clinical Infectious Diseases',
    clase: 'literatura_primaria',
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Revista de referencia de la especialidad del duenio. Hoy, descubrimiento via PubMed y nada mas.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con Oxford University Press o acceso institucional a Clinical Infectious Diseases.',
  },
  nature_medicine: {
    id: 'nature_medicine',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Descubrimiento via PubMed, sin integracion editorial.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con Springer Nature, o su API institucional. Sin eso se queda en descubrimiento via indice.',
  },
  annals: {
    id: 'annals',
    nombre: 'Annals of Internal Medicine',
    clase: 'literatura_primaria',
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Descubrimiento via PubMed, sin integracion editorial.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Acuerdo con el American College of Physicians o acceso institucional a Annals.',
  },
  dynamed: {
    id: 'dynamed',
    nombre: 'DynaMed',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Ni siquiera estaba catalogada, asi que el medico no podia leer «DynaMed: no se consulto». Sin adaptador y sin contrato.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Contrato con EBSCO y credenciales de DynaMed para el consultorio.',
  },
  scopus: {
    id: 'scopus',
    nombre: 'Scopus',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Indice de citas de Elsevier. Sin catalogar hasta hoy; sin adaptador y sin contrato.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Contrato con Elsevier y clave de API institucional para el consultorio.',
  },
  embase: {
    id: 'embase',
    nombre: 'Embase',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Indice biomedico de Elsevier, complementario de MEDLINE. Sin catalogar hasta hoy.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Contrato con Elsevier y clave de API institucional para el consultorio.',
  },
  crossref: {
    ...
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'API publica de metadatos y DOI. NO esta integrada, y su ausencia es la razon de que el DOI se pierda por el camino (WS-07).',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Ninguna externa: es trabajo interno. Se declara aqui para que no vuelva a caerse del mapa.',
  },
  idsa: {
    id: 'idsa',
    nombre: 'IDSA (Infectious Diseases Society of America)',
    clase: 'guia_de_practica',
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Sus guias se citan hoy como CADENAS FIJAS dentro de motores clinicos: no hay objeto de guia, ni version, ni fecha, ni forma de saber si la citada sigue vigente (WS-07).',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la IDSA antes de integrarla como fuente citable.',
  },
  esc: {
    id: 'esc',
    nombre: 'ESC (European Society of Cardiology)',
    clase: 'guia_de_practica',
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Cadena de cita fija dentro de motores clinicos. Sin objeto de guia ni control de vigencia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la ESC antes de integrarla como fuente citable.',
  },
  aha_acc: {
    id: 'aha_acc',
    nombre: 'AHA / ACC',
    ...
    porQue: 'Cadena de cita fija dentro de motores clinicos. Sin objeto de guia ni control de vigencia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de AHA/ACC antes de integrarlas como fuente citable.',
  },
  ats: {
    id: 'ats',
    nombre: 'ATS / ERS',
    ...
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Ni siquiera estaba catalogada. Sin adaptador y sin objeto de guia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la ATS/ERS antes de integrarla como fuente citable.',
  },
  easl: {
    id: 'easl',
    nombre: 'EASL',
    ...
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Sin catalogar hasta hoy. Sin adaptador y sin objeto de guia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la EASL antes de integrarla como fuente citable.',
  },
  ecil: {
    id: 'ecil',
    nombre: 'ECIL',
    ...
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Guias de infeccion en el paciente hematologico. Sin catalogar hasta hoy.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la ECIL antes de integrarla como fuente citable.',
  },
  nccn: {
    id: 'nccn',
    nombre: 'NCCN',
    ...
    rol: 'respaldo',
    licencia: 'REQUIRES_AGREEMENT',
    porQue: 'Sus guias exigen registro y tienen terminos de reuso estrictos. Sin catalogar hasta hoy.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Registro institucional en la NCCN y revision de sus terminos de reuso, que son estrictos.',
  },
  surviving_sepsis: {
    id: 'surviving_sepsis',
    ...
    porQue: 'Cadena de cita fija dentro de motores clinicos. Sin objeto de guia ni control de vigencia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar los terminos de reuso de la Surviving Sepsis Campaign antes de integrarla.',
  },
  cofepris: {
    id: 'cofepris',
    nombre: 'COFEPRIS',
    ...
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'La autoridad sanitaria mexicana. Sin catalogar, pese a que el producto es para Mexico: la ficha oficial de un farmaco en Mexico no la da openFDA.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar si COFEPRIS publica un canal consultable; hoy no consta que lo haga.',
  },
  cenetec: {
    id: 'cenetec',
    nombre: 'CENETEC (GPC de Mexico)',
    clase: 'guia_de_practica',
    rol: 'respaldo',
    licencia: 'LICENSE_UNKNOWN',
    porQue: 'Hoy es UN ENLACE A UNA BUSQUEDA DE GOOGLE presentado como boton. No es una fuente integrada y el catalogo no lo decia.',
    matriz: SIN_VERIFICAR,
    decisionPendiente: 'Revisar si CENETEC publica un catalogo consultable de GPC.',
  },
