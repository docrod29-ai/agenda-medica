 ...
 */
const CACHE = 'nexusmed-v483'  // DIAGNOSTICO DEL AVISO 'la nota NO se esta guardando'. El mensaje decia 'revisa tu conexion' PASARA LO QUE PASARA — una suposicion. Si el fallo es de permisos, de sesion vencida o de tamanio del documento, mandaba al medico a mirar su wifi mientras el problema estaba en otro lado, y mientras tanto seguia dictando creyendo que se guardaba. Ahora el aviso nombra la causa. Ademas se comprueba el TOPE DE 1 MB por documento ANTES de escribir: la nota lleva dentro la transcripcion cruda y el dialogo diarizado, que crecen rapido en consultas largas; al pasar el tope updateDoc falla sin explicar. No se trunca nada — truncar seria perder material clinico de origen en silencio, que es peor que fallar.
