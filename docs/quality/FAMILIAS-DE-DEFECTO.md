...
**Abierto**: 6-ago-2026. **Fuente**: los 59 REG de `docs/audit/regression-ledger.md`.

---

## Por qué contar

El ledger tiene 59 defectos con su causa raíz. Leídos de uno en uno son 57
...
| El habla real no cabía en el motor | 8 | El motor cubre el español que uno *escribiría*, no el que se *habla* en un consultorio mexicano |
...
| Pérdida de datos | 3 | Trabajo del médico que desaparece o reaparece solo |
...
**«Escrito, probado y sin conectar» — 9 de 59, la familia más grande.**
...
**«El sistema se contradice a sí mismo» — 8 de 59.** Ninguna de las dos partes
...
**«Nadie lo estaba midiendo» — 5 de 59**, y cada uno destapó otros al encenderse.
...
aterrice el REG-212, esta prueba se pone roja hasta que alguien conteste «¿de qué
