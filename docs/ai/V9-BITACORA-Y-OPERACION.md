...
| 2026-08-09 | **POSTVISIT-001** | `4bca5e3` | El bucle se cierra: compuerta de firma en dos capas, ruta que compone y libera con `approvedBy` del token, y el paciente lo lee en «Cuidado». Residual: `POSTVISIT-VERSION-001` | **306, 307** |
