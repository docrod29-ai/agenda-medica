...
**Fuente**: los 118 REG clasificados de `docs/audit/regression-ledger.md`.
...
| El habla real no cabía en el motor | 11 | El motor cubre el español que uno *escribiría*, no el que se *habla* en un consultorio mexicano |
