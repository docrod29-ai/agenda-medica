...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **440 REG** con causa raíz |
| Invariantes sellados | **587 archivos, 7960 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 440 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 440 defectos documentados con
