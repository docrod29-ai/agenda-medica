 ...
 */
const CACHE = 'nexusmed-v516'  // NOTA MEMBRETADA MULTIPAGINA (fix de impresion): el membrete de fondo ya se repetia por hoja, pero el texto solo respetaba el margen superior en la HOJA 1 (era padding del #doc) -> en la hoja 2+ arrancaba pegado arriba y se encimaba con el encabezado membretado repetido. Fix sin re-paginar (cero riesgo de perder texto): el contenido se envuelve en una tabla con thead/tfoot espaciadores que los navegadores REPITEN en cada pagina impresa, reservando la banda segura del membrete (top/bottom) en TODAS las hojas; los margenes izq/der los pone el td. Se pasan los margenes reales del membrete (medMembrete.margenes / notaMembreteMargenes, default 42/22/28/22 mm). Solo afecta el boton Imprimir de la nota. Pendiente aparte: el PDF descargado (html2pdf) estira el membrete en notas de >1 pagina (rasteriza y rebana); las de 1 pagina salen bien.
