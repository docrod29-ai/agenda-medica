...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **54 REG** con causa raíz |
| Invariantes sellados | **231 archivos, 3574 casos** que no pueden encoger |
| Suite completa | **7253 pruebas** en verde, en CI |
...
✅ El `regression-ledger` **es** el historial: 54 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 54 defectos documentados con
...
**Fuerte**: seguridad documentada, aislamiento probado en CI, 7253 pruebas,
