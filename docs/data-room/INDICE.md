...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **240 REG** con causa raíz |
| Invariantes sellados | **400 archivos, 5806 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 240 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 240 defectos documentados con
