...
re-puntuación §29 del 14-ago —que es la que manda sobre el cierre de la
iteración— abrió dos más: **RTC-15** (ya existía como P2, subió de prioridad
con un número delante) y **RTC-29** (nuevo). RTC-15 se pagó el mismo día y está
arriba, en Cerrados; queda éste.
