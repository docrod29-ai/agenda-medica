 ...
 */
const CACHE = 'nexusmed-v487'  // LA NOTA YA NO ESPERA A QUE SE SEPAREN LAS VOCES. Al detener el dictado el medico se quedaba mirando una pantalla vacia durante DOS esperas en serie: subir el audio completo y transcribirlo OTRA VEZ con separacion de voces —que en una consulta larga no es rapido— y solo entonces estructurar la nota con la IA. La primera espera ni siquiera hacia falta para empezar: el texto del streaming en vivo YA estaba en pantalla. Ahora se estructura en cuanto se detiene, con lo que hay, y cuando llega el texto con Medico/Paciente separados —que es mejor material— se re-proyecta. Con una salvaguarda que antes no hacia falta y ahora si: si el medico ya empezo a escribir sobre la nota adelantada, la re-proyeccion NO lo pisa en silencio, le pregunta y el decide. Ademas la pasada preliminar no pide segunda opinion: se pagaria dos veces por revisar una nota que esta por reemplazarse, y el medico veria hallazgos de una version que ya no existe.
