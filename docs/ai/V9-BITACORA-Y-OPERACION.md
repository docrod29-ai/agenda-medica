...
| 2026-08-09 | **POSTVISIT-001** | `35fba2d` | El paquete se genera del encuentro y **sólo se libera con aprobación del médico**: compuerta de firma en el motor, composición en el servidor, `firmar` como capacidad, versiones sin reescritura, y «Cuidado» del paciente ya lo enseña | **306, 307** |
