...
| Casos declarados en el árbol | **13191** en 1106 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **597 archivos · 8197 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-669** | `docs/audit/regression-ledger.md` |
