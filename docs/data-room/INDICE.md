...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **129 REG** con causa raíz |
| Invariantes sellados | **298 archivos, 4371 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 129 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 129 defectos documentados con
