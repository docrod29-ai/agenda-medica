...
| 2026-08-09 | **`PATIENT-TELE-002`** (fuera de orden: era el último P0) | *(esta rama)* | El enlace de la videoconsulta que viaja por WhatsApp ya lleva token · plazo derivado de la cita, techo de 3 días, alcance mínimo · el primer guardián no fallaba al revés y se reescribió | **292** |
