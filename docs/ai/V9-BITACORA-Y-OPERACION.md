...
| 2026-08-09 | **POSTVISIT-001** | `7e1438e` | El paquete se compone de la nota **firmada** (compuerta con nombre), lo compone el **servidor**, se libera con aprobación de la sesión y **llega** al portal del paciente. Vuelven `componerPaquete` y `cambiosDeMedicacion`, con quien las llama | **306** |
