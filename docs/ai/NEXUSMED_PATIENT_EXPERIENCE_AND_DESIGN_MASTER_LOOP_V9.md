...
| 2026-08-09 | **A11Y-GATE-001** *(parcial)* | `3125a98` | Motor WCAG determinista + compuerta de contraste en los dos temas · nombre accesible y teclado parseados con TypeScript, techo **cero** · falta `axe` en navegador (`A11Y-AXE-001`) | **292, 293** |
| 2026-08-09 | **NAVIGATION-001** | *(este commit)* | Una sola lista de campos del borrador (tres caminos la copiaban) · «atrás» que vuelve de verdad y lo dice · agenda y calendario recuerdan su encuadre · el botón central deja de enlazar a sí mismo | **294, 295, 296** |
