...
**Fuente**: los 127 REG de `docs/audit/regression-ledger.md`.
...
**«Escrito, probado y sin conectar» — 32 de 127, y el 7-ago-2026 volvió a ser la
familia más grande.**
...
**«El sistema se contradice a sí mismo» — 16 de 127.**
...
**«Nadie lo estaba midiendo» — 20 de 127**, y cada uno destapó otros al encenderse.
