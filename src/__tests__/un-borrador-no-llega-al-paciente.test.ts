 ...
 * - **No prueba la composición** (`componerPaquete`, `cambiosDeMedicacion`) ni
 *   su regla de «sin lista previa, `null` y no "sin cambios"». Eso vive en
 *   `el-paquete-se-compone-de-la-nota-firmada.test.ts` (POSTVISIT-001), que
 *   llegó con el llamador: la pantalla del médico en la consulta y
