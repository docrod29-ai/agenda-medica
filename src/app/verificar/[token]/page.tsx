...
export const metadata: Metadata = {
  title: 'Verificación de documento · Ausculta',
  robots: { index: false, follow: false },
}

/**
 * Verificación pública de una receta dentro de Ausculta (destino del QR).
    ...
    <main style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 460, background: 'var(--s1)', border: '1px solid var(--border)', borderRadius: 16, padding: 28 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 18 }}>
          <div style={{ width: 32, height: 32, borderRadius: 6, background: 'var(--nexus-soft)', display: 'grid', placeItems: 'center', color: 'var(--nexus)' }}>
        ...
        {!r ? (
          ...
          <div>
            ...
            <Fila k="Cédula profesional (registrada en Ausculta)" v={r.cedula || '—'} />
            ...
            <p style={{ fontSize: 11.5, opacity: 0.6, marginTop: 12 }}>
              La cédula mostrada es la registrada por el médico en Ausculta; Ausculta <strong>no</strong> la valida ante la autoridad.
              Esta página confirma que el certificado <strong>lo emitió Ausculta para este folio</strong>, con el contenido cuya
        ...
        <p style={{ fontSize: 11, opacity: 0.55, marginTop: 18, borderTop: '1px solid var(--border)', paddingTop: 12, lineHeight: 1.5 }}>
          La verificación dentro de Ausculta no sustituye los requisitos legales, la firma profesional
