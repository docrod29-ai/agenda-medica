 ...
 */
const CACHE = 'nexusmed-v476'  // MODULO 5 (antibiograma), LOTE 1 — los 3 P0, todos de PLOMERIA sobre microbiologia que estaba bien. (1) El motor buscaba los sinonimos con includes, y los betalactamicos nuevos son COMBINACIONES cuyo nombre contiene el del agente suelto: 'Meropenem-vaborbactam S' hacia que CARBAPENEM viera una S y una K. pneumoniae pan-carbapenem-R quedara como 'perdida de porina', SIN alerta critica, sin terapia dirigida, sin notificacion NOM-045 y sin aislamiento. El alias 'avibactam' casaba 'Aztreonam-avibactam' y el motor concluia carbapenemasa de SERINA — al reves, porque ese es el farmaco de las MBL. Y una Klebsiella S a amox-clav (lo normal) disparaba alarma de resistencia intrinseca. (2) Lo CONFIRMADO por PCR perdia contra lo inferido: el dedup conservaba el primero y la inferencia se fusiona antes, asi que una KPC confirmada salia como 'clase no determinada' y la terapia prescribia y prohibia CAZ-AVI en la misma lista. (3) Los conflictos intrinsecos miraban solo la primera fila del panel.
