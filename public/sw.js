 ...
 */
const CACHE = 'nexusmed-v468'  // MODULO 1, LOTE 3 — cierre. (1) LA CONSULTA ANTERIOR SE COLABA EN LA NOTA NUEVA: el resultado de la IA quedaba en el provider del layout y nunca se limpiaba, mientras el contador de aplicado se reiniciaba en cada montaje; al firmar y abrir una 2a consulta del mismo paciente se volcaban resumen, secciones, Dx y medicamentos de la anterior en la nota vacia. Ahora el resultado recuerda a que nota pertenece y se consume una sola vez. (2) Si fallaba la carga de un borrador, el autoguardado lo VACIABA a los 30s (notaIdRef ya apuntaba al documento sin haberlo leido); ahora se avisa y se bloquea el guardado. (3) El pase en vivo borraba los Dx y el texto escritos a mano mientras dictabas; ahora en vivo la IA solo rellena huecos. (4) El sello de integridad se calculaba sobre un UUID que cambiaba en cada render. (5) El ensamble truncaba la nota a 20k caracteres y fusionaba sobre un JSON partido.
