 ...
 */
const CACHE = 'nexusmed-v473'  // MODULO 3 (impresos), LOTE 1. (1) SUPLANTACION: en un consultorio de 2 medicos podia salir la FIRMA ESCANEADA DEL OTRO. El match por medico casi siempre falla (las notas se sellan con uid y la config guarda por id de doctors), y la regla de respaldo usaba 'la unica firma que hubiera' para cualquiera. Con varios medicos ya no se adivina, y si no hay firma se AVISA antes de imprimir: una firma ausente se nota, una ajena no. (2) El .doc de la ORDEN afirmaba 'ALERGIAS: Negadas / no referidas' para un paciente alergico, mientras el PDF de esa misma orden imprimia la alergia real — peligroso en estudios con contraste. Ademas 'Negadas' ya no se afirma desde un campo vacio: no es lo mismo que el paciente niegue a que nadie pregunte. (3) El QR de verificacion NUNCA funciono: la llamada iba sin autenticacion y respondia 401 siempre, con dos catches que se lo tragaban. (4) Arrastrar el folio al pie del formato borraba los medicamentos en silencio. (5) Un medicamento vacio se imprimia como vineta numerada en blanco. (6) La carta de referencia se quedaba en 'Cargando...' para siempre.
