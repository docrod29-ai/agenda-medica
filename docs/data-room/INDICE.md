...
| Invariantes sellados | **329 archivos, 4676 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 171 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 171 defectos documentados con
