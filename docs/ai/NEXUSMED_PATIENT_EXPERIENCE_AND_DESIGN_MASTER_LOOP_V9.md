...
| 2026-08-09 | **DESIGN-SYSTEM-001 · parte 1** | `9e48b04` | `@theme inline` pasa de 4 valores a las familias del sistema · 18 sitios que pintaban el azul de marca a mano por debajo de AA · escalas de radio y espacio sacadas de los picos reales · guardián con contraste **computado** y comprobación al revés | **291** |
| 2026-08-09 | **`PATIENT-TELE-002`** (fuera de orden: era el último P0) | `828c338` | El enlace de la videoconsulta que viaja por WhatsApp ya lleva token · plazo derivado de la cita, techo de 3 días, alcance mínimo · el primer guardián no fallaba al revés y se reescribió | **292** |
