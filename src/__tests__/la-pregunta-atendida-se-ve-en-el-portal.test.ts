...
/**
 * LA PREGUNTA ATENDIDA SE VE EN EL PORTAL — REG-516 (cierra el bucle de REG-514).
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
 * REG-514 hizo que toda pregunta escalada abriera una tarea en `/pendientes`.
 ...
 * revisó» del portal era código muerto (lo declaró el propio REG-514).
 *
 * ── LA CAUSA RAÍZ ────────────────────────────────────────────────────────────
 *
 ...
 * `/pendientes` anterior a REG-516, se pone rojo: no llamaba a nada al cerrar.
 *
 * ── QUÉ NO CUBRE ─────────────────────────────────────────────────────────────
 *
...
describe('REG-516 · la ruta que marca atendida la pregunta', () => {
...
describe('REG-516 · /pendientes marca la pregunta al cerrar SU tarea, y sólo la suya', () => {
