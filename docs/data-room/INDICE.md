...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **304 REG** con causa raíz |
| Invariantes sellados | **460 archivos, 6687 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 304 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 304 defectos documentados con
