 ...
 */
const CACHE = 'nexusmed-v469'  // HISTORIAL DE VERSIONES: existia pero no se podia usar. Cada autoguardado ya copiaba lo que iba a pisar, pero NINGUNA pantalla lo leia — era un historial de solo escritura, y es la unica via de rescate cuando dos pestanas (o el telefono y la computadora) se pisan la misma nota. Ahora hay pantalla para ver y restaurar. Ademas se escribian DOS copias completas de la nota cada 30s (unos 80 documentos por consulta de 20 min) en formatos incompatibles: una guardaba el estado NUEVO bajo 'timestamp' pese a que su comentario decia guardar el anterior, y otra el PREVIO bajo 'versionadoEn'; como cada lector ordenaba por el campo que el otro no escribia, Firestore excluia en silencio la mitad del historial. Se quedo la correcta y se registra quien provoco cada version.
