      ...
      */}
      ...
      {(() => {
        ...
        /* `flex-start` y no `center`: el campo de alergias crece a varias líneas
           ...
           media altura de un bloque de tres renglones. La clase es de REG-520. */
        return (
      <div className="nx-franja-alergias" style={{
        ...
        */}
        <textarea
           ...
           * rama, REG-514: a 390 px una lista de tres alérgenos se recortaba) y
      ...
      {(voz.grabando || audio.estado === 'grabando') && !panelALaVista && (
        <div style={{
          ...
          <span style={{ fontSize: 13, fontWeight: 700, color: 'var(--text)', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
            {/* El rótulo y el reloj salen del vocabulario común (REG-515): esta
