 ...
 */
const CACHE = 'nexusmed-v493'  // CONCILIACION DE MEDICAMENTOS: bloqueo optimista. La conciliacion reemplaza la lista ENTERA con lo que manda el cliente, no la fusiona. Sin control, dos dispositivos que abren la conciliacion, editan por separado y guardan producian un lost-update: ganaba el ultimo y borraba en silencio los medicamentos que agrego el otro, en una lista de la que dependen decisiones de prescripcion. Ahora el cliente manda el sello (conciliadoAl) que vio al cargar y el servidor RECHAZA si alguien mas guardo en medio, pidiendo recargar en vez de pisar el trabajo del otro.
