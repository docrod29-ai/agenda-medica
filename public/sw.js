 ...
 */
const CACHE = 'nexusmed-v510'  // SUPER AUDITORIA DE LA CONSULTA (5 auditores) - LOTE 1 de reparaciones. PERDIDA DE DATOS: signos, estudios de orden y preop NO contaban como contenido, asi que una nota de solo-signos o solo-estudios NUNCA se autoguardaba ni respaldaba y se perdia al navegar/cerrar; ademas estudiosOrden/preop no estaban en los respaldos ni se restauraban. Ahora cuentan y se respaldan/restauran en las 5 vias. FLUIDEZ: la nota preliminar (v487) corria el motor COMPLETO (Opus+razonamiento ~40s) en vez del rapido — el medico esperaba igual mirando la pantalla; ahora va en Haiku (~5-8s) y la nota buena queda para la re-proyeccion diarizada. ATAJO DE GRABAR: Cmd/Ctrl+Shift+G miraba voz.grabando (siempre false en modo whisper) → ni detenia ni evitaba arrancar un 2o grabador en paralelo; ahora controla el grabador activo. HERRAMIENTAS: reagregar la misma herramienta DUPLICABA texto (dedup); el Copiloto marcaba 'ya esta en la nota' aunque estuviera firmada (falso exito → respeta el boolean); LABS INTEGRADOS A LA NOTA (boton Agregar a la nota, opt-in). RECETA/ORDEN: firmar con solo estudios NO llevaba a la orden (ahora si); se podia imprimir receta/orden EN BLANCO (candado de contenido).
