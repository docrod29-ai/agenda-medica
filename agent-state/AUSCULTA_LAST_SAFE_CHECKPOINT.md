...
## Checkpoint · 5-sep-2026 — **Preservation, Audit & Intelligence Transformation · cuatro P1 cerrados y la receta empezada (REG-512…519) · tres decisiones del dueño escritas (D-032…034)**
...
LAST_COMPLETED_UNIT=REG-519 — el bloqueo ARCO revoca el portal en el mismo acto (D-034). D-032 (alergia: sólo avisar) y D-033 (la pregunta viaja completa) escritas en el código que gobiernan
