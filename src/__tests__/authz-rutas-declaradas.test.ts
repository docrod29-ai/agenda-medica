...
describe('E0-07 · el registro no puede MENTIR sobre el código (por MÉTODO y por ARGUMENTO)', () => {
  ...
  it('el ANALIZADOR no pasa por vacío (si se rompe, todo lo de arriba pasaría sin comprobar nada)', () => {
    ...
    // abierto.
    expect(llamadas.length).toBe(98)   // +1 el 2026-08-09: `expediente/paquete-visita` (V9 · POSTVISIT-001 — el médico libera al paciente el resumen de su consulta; GET lee lo liberado, POST compone desde la nota firmada y aprueba). Sube DOS: GET y POST, cada uno con su `verificarCapacidad`.  // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    expect(rutasConGuardia).toBe(80)   // +1 el 2026-08-09: `expediente/paquete-visita` (V9 · POSTVISIT-001 — el médico libera al paciente el resumen de su consulta; GET lee lo liberado, POST compone desde la nota firmada y aprueba).  // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
...
describe('E0-07 · propiedad heredada de E0-06, ahora expresada en capacidades', () => {
  ...
  it('el control de que la comprobación anterior NO pasa por vacío', () => {
    ...
    // `expediente/paquete-visita` es la décima (V9 · POSTVISIT-001): lee la nota
    // FIRMADA para componer lo que el paciente va a leer, y va bajo
    // `clinico.leer` / `clinico.escribir`.
  ...
  it('las rutas que tocan la IDENTIDAD del paciente están congeladas (segundo nivel de PHI)', () => {
    ...
    expect(conPaciente).toEqual([
      ...
      /**
       * V9 · POSTVISIT-001. Lee el expediente del paciente —su nota firmada y
       * su versión de enlace del portal— para componer y liberar lo que él va a
       * leer, y emite el enlace con el que entra. Va bajo capacidad clínica.
       */
