 ...
 */
const CACHE = 'nexusmed-v464'  // AUDITORIA MODULO 0, LOTE 4 (normativa). (1) BITACORA YA NO FORJABLE: se escribia desde el navegador con reloj del navegador y create:isMember sin validar nada, asi que cualquier miembro podia fabricar entradas con el correo y la fecha que quisiera o atribuir un acceso a otro medico; ahora pasa por /api/auditoria/registrar con identidad del ID-token y serverTimestamp, y las reglas cierran create/update/delete al cliente. (2) Se emiten eventos que NUNCA se registraban: inicio de sesion, alta y modificacion de paciente, receta impresa/descargada y orden generada. (3) El aviso de privacidad ya no promete MFA que no existe. (4) Se retiro el consentimiento VERBAL para datos de salud (Art. 9 LFPDPPP exige por escrito). (5) createAuditLog era codigo muerto: eliminado.
