...
| Casos declarados en el árbol | **10962** en 870 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **457 archivos · 6638 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
