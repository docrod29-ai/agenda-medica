 ...
 */
const CACHE = 'nexusmed-v384'  // Mobile Excellence iter 8-11 (aún en rama): notificaciones sin PHI (§8.6), logs sin material de secretos (§9.5), guards de accesibilidad/zoom, y PWA: shortcuts en el manifest + NO cachear el HTML de rutas clínicas (defensa en profundidad §11.2). Escritorio intacto.
