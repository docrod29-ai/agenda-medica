 ...
 */
const CACHE = 'nexusmed-v467'  // MODULO 1, LOTE 2 — las 3 decisiones del Dr. (1) OPCION B: la IA sigue completando el plan (ahorra dictado y suele acertar) pero MARCA cada linea que el medico no dicto con '[IA - no dictado]'; antes de firmar hay que aceptarlas como propias o quitarlas, y no se puede firmar con la marca puesta. Antes el prompt ordenaba literalmente 'completalo con lo que aplique' y el plan era obligatorio para firmar: se firmaba conducta clinica no indicada, con cedula. (2) revisadoPorHumano ya NO es una tautologia: firmar era lo que lo ponia en true, asi que el registro nunca podia decir 'firmada sin revisar', que es justo el evento auditable; ahora es true solo si el medico acepto campos, y se guarda cuantos. NO se bloquea firmar sin revisar. (3) El diccionario de farmacos ya se aplica a los TURNOS diarizados: el medico veia 'ceftriaxona' en pantalla y el modelo recibia 'sefriaxona', justo en el camino con separacion de voces.
