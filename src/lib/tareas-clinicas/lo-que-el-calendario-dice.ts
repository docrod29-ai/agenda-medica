 ...
 * dos candidatas indistinguibles. Es el patrón de REG-570: el identificador lo
 * acuña quien hace la acción y viaja con ella, en su propio campo — meterlo en
 * `notaId` sería un campo haciendo dos trabajos, que es REG-566.
 *
...
export const POR_QUE_HACE_FALTA_EL_ID =
  ...
  + 'agenda y viaja con la tarea, en su propio campo — como en REG-570.'
