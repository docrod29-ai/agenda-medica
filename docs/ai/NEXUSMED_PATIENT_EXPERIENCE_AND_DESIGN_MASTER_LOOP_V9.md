...
| 2026-08-09 | **A11Y-GATE-001** *(parcial)* | *(este commit)* | Motor WCAG determinista + compuerta de contraste en los dos temas · nombre accesible y teclado parseados con TypeScript, techo **cero** · falta `axe` en navegador (`A11Y-AXE-001`) | **292, 293** |
