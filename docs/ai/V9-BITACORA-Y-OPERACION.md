...
| 2026-08-09 | **`PATIENT-TELE-002`** (P0, fuera de turno) | *(este commit)* | El token de la sala se acuña en el servidor: la videoconsulta anunciada por WhatsApp ya lleva enlace. **Cero P0 abiertos en V9** | **309** |
