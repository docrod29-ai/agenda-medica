...
| 2026-08-09 | **DESIGN-SYSTEM-001** | `b470652` | `@theme` pasa de 4 a **43 tokens** con utilidad cada uno · se comprueba compilando que **llegan** · tres compuertas con techo que sólo baja (deriva **2 600**, accesibilidad **312**) y la regla «un archivo nuevo nace limpio» · 7 clases muertas fuera · +33 casos | — |
