...
export const FAMILIAS: readonly FamiliaDeDefecto[] = [
  ...
  },
  {
    ...
    regs: [171, 179, 180, 189, 191, 194, 196, 199, 214, 217, 223, 226, 229, 234, 269, 270, 272, 273, 277, 278, 279],
  },
  {
    clave: 'habla_real',
    ...
    regs: [158, 186, 187, 192, 200, 209, 210, 211, 212, 220, 271, 275, 276, 280, 281, 282],
  },
  {
    clave: 'sin_medir',
