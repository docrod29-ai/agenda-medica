...
| Casos declarados en el árbol | **13170** en 1104 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **595 archivos · 8176 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-667** | `docs/audit/regression-ledger.md` |
