...
| C-6-bis | **Las formas concretas que hoy disparan el aviso contra una nota correcta** (reproducidas 7-ago, REG-193): «Negó diabetes» —falla sólo por el acento, `nieg[ao]` no cubre `negó`—, «Sin diabetes», «No es diabético», «Diabetes: negada», «DM2 (-)» | Añadir al menos la **morfología de lo ya aprobado** («negó», «negaba»); el resto es vocabulario nuevo y lo decide el Dr. | Que el aviso deje de saltar contra una nota bien escrita | El aviso corre; el falso positivo está declarado y medido |
