...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **155 REG** con causa raíz |
| Invariantes sellados | **313 archivos, 4550 casos** que no pueden encoger |
| Suite completa | **8 596 pruebas** en verde (1 fallo de entorno declarado: `ops-timeout`) |
...
✅ El `regression-ledger` **es** el historial: 155 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 155 defectos documentados con
...
**Fuerte**: seguridad documentada, aislamiento probado en CI, 8 596 pruebas,
