 ...
 */
const CACHE = 'nexusmed-v181'  // Hospital interoperabilidad: export FHIR R4 del internamiento (Encounter + MedicationRequest + MedicationAdministration + Observation seriados)
