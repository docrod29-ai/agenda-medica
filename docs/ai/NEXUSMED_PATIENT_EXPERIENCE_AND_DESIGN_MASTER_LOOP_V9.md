...
| 2026-08-09 | **A11Y-GATE-001** | `0ff030b` | Nombre accesible: **cero** en las 9 rutas del paciente, trinquete de 312 en el resto · 9 controles reparados, entre ellos los 5 del formulario ARCO y las 5 estrellas de `/resena` | **292** |
| 2026-08-09 | **DESIGN-SLATE-001** | *(esta sesión)* | Las 9 rutas del paciente sacan su color de un token, con excepciones declaradas una a una · `.spin`/`.nx-pulse`/`.nx-caret` dejan de depender de que otra pantalla esté montada · 6 rellenos con el token del TEXTO (2,95:1 en claro) corregidos, incluido el `Sidebar` | **293, 294, 295** |
