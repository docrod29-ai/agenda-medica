...
| Casos declarados en el árbol | **10932** en 868 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **455 archivos · 6608 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
