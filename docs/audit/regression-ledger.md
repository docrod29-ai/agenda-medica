...
**El número lo puso quien fusiona, no quien escribió** — Esta entrada nació sin
número: el 8-ago-2026 había **14 PRs abiertos titulados «REG-192 · v1074»**
porque cada disparo del bucle partía de `main`, veía el mismo último REG y elegía
el mismo siguiente. Reclamar uno más habría sido el decimoquinto. Al repartir la
secuencia desde `main` por número de PR ascendente (OPS-003, PR #251) le tocaron
**REG-213 y v1095**. Es lo que pedía la M-2 de `OWNER_DECISIONS_REQUIRED.md`.
