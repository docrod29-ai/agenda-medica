...
- **v1074** — REG-192 (EVAL-002 del backlog). El motor de TEMPORALIDAD se midió por primera vez: se escribieron 49 frases y 12 notas sintéticas —positivos Y negativos, porque un corpus de sólo positivos premia al motor que marca todo— y se corrieron contra el motor REAL antes de tocar una línea. **9 de 61 fallaron**, ninguno rompía una prueba. (1) «en control» y «en tratamiento» ANULABAN el pretérito: «le operaron de la vesícula en 2018 y quedó en control» se leía como presente — el control era de entonces, igual que la cirugía. (2) En la nota sólo se miraba la PRIMERA aparición, así que un antecedente BIEN escrito arriba tapaba la afirmación en presente de abajo: bastaba con que la nota estuviera bien escrita una vez para dejar de mirarse. (3) «Derrame pleural» se etiquetaba como EVENTO VASCULAR CEREBRAL. (4) «Le extirparon el apéndice» salía sin padecimiento que contrastar. Causa raíz única: el motor era una carrera de regex SIN ORDEN DECLARADO. Ahora el orden ES la política —continuidad > pretérito > estado > marca de tiempo— y la nota se mira entera. Gramática y vocabulario: NI UNA cifra clínica nueva. VERIFICADO que puede ponerse rojo (7 de 14 casos). Queda para el Dr.: el número sobre habla REAL sigue dependiendo de E-1, y el vocabulario sigue siendo vocabulario (gastroenteritis está dicha en pasado y no se vigila — el corpus lo deja escrito).
