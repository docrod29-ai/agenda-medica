...
/**
 * El tipo y las etiquetas viven en un módulo PURO y se re-exportan aquí.
 *
 * Se re-exportan —en vez de obligar a todo el repositorio a cambiar de import—
 * porque `audit-log.ts` sigue siendo la puerta natural: quien escribe en la
 * bitácora pide aquí lo que necesita. Lo que cambió es que el SERVIDOR puede
 * pedir sólo las etiquetas sin arrastrar el SDK del navegador (REG-059).
 */
export { EVENTO_LABEL, etiquetaEvento, type AuditEvento } from '@/lib/expediente/audit-eventos'
