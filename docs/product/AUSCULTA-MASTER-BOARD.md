...
| Casos declarados en el árbol | **13182** en 1105 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **596 archivos · 8188 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-668** | `docs/audit/regression-ledger.md` |
