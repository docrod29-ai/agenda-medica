...
/**
 * ── UNA INTERCONSULTA PEDIDA NO ENTRABA AL BUCLE (REG-570) ──────────────────
 *
 ...
 * reintento y no lo duplica. Es la doctrina de REG-567 aplicada aquí.
 */
 ...
 * interconsulta anterior a REG-570, o una pedida sin paciente en la mano, nunca
...
/**
 * ── UN REGISTRO DE SIGNOS DUPLICADO ALTERA UNA ESCALA — REG-567 ─────────────
 *
...
export async function corregirSignos(
  ...
  /** REG-567. Una corrección duplicada deja DOS enmiendas del mismo original. */
...
/**
 * REG-567 — una solicitud de laboratorio duplicada se le TOMA DOS VECES al
