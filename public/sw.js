 ...
 */
const CACHE = 'nexusmed-v478'  // MODULO 5, CIERRE. (1) HLAR FALSO: se declaraba con una gentamicina R de PANEL RUTINARIO, pero el enterococo es intrinsecamente R de bajo nivel a aminoglucosidos — esa R es lo esperado. Se abandonaba la sinergia betalactamico+aminoglucosido en endocarditis sin fundamento. Ahora exige el TAMIZ DE ALTO NIVEL, y si solo hay gentamicina de rutina se pide explicitamente. (2) La CMI censurada perdia el simbolo: '>500' se leia como 500 exacto contra un umbral estricto >500, daba falso y apagaba el HLAR, imprimiendo la didactica de que el aminoglucosido aporta por sinergia — el consejo contrario. El simbolo es informacion clinica. (3) FRONTERA IA: las alertas criticas del motor (infectologia obligada, aislamiento, notificacion NOM-045) NO llegaban al prompt, asi que el modelo razonaba sin ellas; ahora si. Y la regla anti-contradiccion era solo texto del prompt: se anade validacion POSTERIOR que detecta si el texto recomienda un farmaco reportado R, marcado 'evitar' o intrinsecamente resistente, y lo anota en pantalla en vez de censurar el razonamiento.
