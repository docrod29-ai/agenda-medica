...
/**
 * LA PREGUNTA ESCALADA LLEGA AL WORKLIST, HAYA TELÉFONO O NO — REG-514.
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
...
describe('REG-514 · la escalación abre una tarea en el worklist', () => {
...
describe('REG-514 · la función pura que arma la tarea', () => {
  const base = {
