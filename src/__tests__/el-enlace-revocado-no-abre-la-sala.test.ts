...
/**
 * EL ENLACE REVOCADO NO ABRE LA SALA DE VIDEO — REG-512.
 *
 * ── QUÉ FALLABA ──────────────────────────────────────────────────────────────
 *
...
describe('REG-512 · el enlace revocado no abre la sala de video', () => {
...
describe('REG-512 · guardián: quien acepta el token del paciente comprueba su revocación', () => {
