...
## SIN DESPLEGAR — v1074 y v1075, cada una en su rama
...
| **1075** | **REG-193 — el escudo de una oración le prestaba silencio a la siguiente** (rama `agent/expediente/TEMP-001-escudo`). Es el límite que la v1074 dejó declarado y anotado como TEMP-001: la ventana de 60 caracteres que busca el escudo se contaba a ciegas y CRUZABA EL PUNTO, así que «Niega diabetes.» escudaba a la hipertensión de la oración siguiente. El caso caro era la nota de REG-192 escrita CORTA —«Antecedentes: neumonía en 2019. Impresión diagnóstica: neumonía adquirida.»—: ahí los 60 caracteres todavía alcanzaban «Antecedentes» y la impresión diagnóstica se callaba igual que antes de repararla. El aviso dependía de cuánto hubiera escrito el médico en el renglón de arriba. Ahora el escudo alcanza desde donde empezó ESTA afirmación (punto, interrogación, admiración y salto de línea la cierran) y el encabezado de sección se consulta aparte, porque los dos puntos no cierran: abren y gobiernan su sección — que es lo que salva «Antecedentes personales patológicos:\nNeumonía en 2019.», la razón de no haberlo tocado a ojo. De paso desaparece una falsa alarma que ya existía: la lista bajo encabezado largo separada por puntos. La ventana de 60 NO se movió. **Queda declarado**: el encabezado que no cabe en la ventana no escuda, y la prosa larga acabada en dos puntos todavía puede escudar de más. |
