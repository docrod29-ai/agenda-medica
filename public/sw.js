 ...
 */
const CACHE = 'nexusmed-v461'  // AUDITORIA MODULO 0, LOTE 1 DE REPARACIONES. (1) LENTITUD, causa raiz: useAppointments se suscribia a TODAS las citas de la clinica (sin where, sin limit) y se monta en toda pantalla del panel; con anos de historial son varios MB de JSON parseados antes de pintar. Ahora va en ventana de 120 dias que se AMPLIA sola cuando navegas hacia atras. usePatientAppointments tiene su propia consulta por paciente. (2) NOTA SIN FIRMAR QUE SE VOLVIA ILEGIBLE al cerrar sesion: el desmonte reescribia el borrador ya purgado y con la clave equivocada; pestillo + secreto pegajoso. (3) FIRMA DEL MEDICO: recepcion podia LEERLA y SUSTITUIRLA en config/main; ahora bloqueada por campo en las reglas. (4) superadmin exige correo verificado.
