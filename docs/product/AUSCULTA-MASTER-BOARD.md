...
| Casos declarados en el árbol | **13286** en 1117 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **604 archivos · 8258 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-677** | `docs/audit/regression-ledger.md` |
