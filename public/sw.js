 ...
 */
const CACHE = 'nexusmed-v994'  // La bitácora de cada versión vive en docs/maintenance/sw-changelog.md (v953: pesaba 271 KB aquí y se bajaba entera en cada carga).
// (v601):
