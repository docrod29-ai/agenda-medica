 ...
 */
const CACHE = 'nexusmed-v180'  // Hospital seguridad del medicamento: CDS en el punto de orden + verificacion farmaceutica + BCMA (5 correctos + brazalete) + conciliacion
