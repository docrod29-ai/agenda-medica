      ...
      {d && !cargando && (
        <>
          ...
          <div style={{ border: '1px solid var(--border)', borderRadius: 10, padding: '13px 15px', marginBottom: 20 }}>
            ...
            <button onClick={guardar} disabled={guardando} style={{ marginTop: 12, background: 'var(--teal)', color: '#000', border: 'none', borderRadius: 8, padding: '8px 16px', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>
