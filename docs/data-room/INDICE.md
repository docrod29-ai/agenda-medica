...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **256 REG** con causa raíz |
| Invariantes sellados | **416 archivos, 5993 casos** que no pueden encoger |
...
✅ El `regression-ledger` **es** el historial: 256 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 256 defectos documentados con
