...
| B-13 | **Dos escritores sobre `main` sin coordinar** (6-sep-2026). Mientras corría el CI del PR #459 (REG-515…531, v1183), otra sesión fusionó #457 y #460 con REG-515…518, `nexusmed-v1183` y D-032. Novena colisión del contador y la primera de versión de service worker y de decisión. Se reconcilió renumerando (REG-519…535, D-033…035, v1184) y fusionando `main` otra vez | Un contador de REG, de versión y de decisiones que reserve el número al abrir el corte (o un solo escritor a la vez, como dice `AGENTS.md` §6-10) | Cada colisión cuesta una fusión entera con sus compuertas; con tres contadores distintos, tres veces |
