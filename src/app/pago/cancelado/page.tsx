...
export default function PagoCanceladoPage() {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 440, background: 'var(--s1)', border: '1px solid color-mix(in srgb, var(--red) 30%, transparent)', borderRadius: 16, padding: '32px 28px', textAlign: 'center' }}>
