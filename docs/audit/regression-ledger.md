...
## REG-270 — el escudo cruzaba de apartado y anulaba a REG-192 (v1151)
...
Verificado otra vez contra `main` en `4bca4c8`, ya con la v1150 dentro.
...
**Reparación** — El contexto previo se recorta en el último punto, salto de línea
o punto y coma.

**Los dos puntos NO cortan, y ésa fue la primera versión equivocada** — Cortar
allí parece lo natural («ANTECEDENTES:» abre un apartado) y rompe el caso
legítimo, porque **el encabezado es el escudo**: en «Antecedentes personales
patológicos: neumonía en 2019» lo único que escuda a esa neumonía está al otro
lado de los dos puntos. Cortando allí, el motor avisaba del antecedente **bien
escrito** y se callaba el diagnóstico de abajo — al revés de lo que hay que
hacer. Lo cazó el golden de REG-192 al correr la suite entera; queda fijado con
dos casos propios. La coma tampoco corta: «niega diabetes, hipertensión y asma»
es una sola enumeración negada.
...
frecuencia—. Se anota en el backlog como SAFE-008 en vez de colarlo en esta
entrada: mezclar dos defectos en un REG es lo que hace que el segundo se olvide.

**Sobre el número** — Nació como REG-193/v1075 sobre el `main` de las 23:13. Para
cuando pasó las compuertas, `main` iba por REG-269/v1150. Se renumeró a
REG-270/v1151 en vez de dejar un número ya tomado: es el efecto de T-1, y aquí se
resolvió mirando `main` otra vez antes de subir.
