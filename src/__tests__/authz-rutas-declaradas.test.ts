...
describe('E0-07 · el registro no puede MENTIR sobre el código (por MÉTODO y por ARGUMENTO)', () => {
  ...
  it('el ANALIZADOR no pasa por vacío (si se rompe, todo lo de arriba pasaría sin comprobar nada)', () => {
    ...
    // abierto.
    expect(llamadas.length).toBe(97)   // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`; +1 el 2026-08-09: `expediente/paquete-visita`
    expect(rutasConGuardia).toBe(80)   // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`; +1 el 2026-08-09: `expediente/paquete-visita`
    ...
    expect(conVocabulario).toBe(54)   // +1 el 2026-08-04: `arco/oponerse`; +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`; +1 el 2026-08-09: `expediente/paquete-visita` (nace con `verificarCapacidad`, no con `verificarMiembro`)
  })
...
describe('E0-07 · propiedad heredada de E0-06, ahora expresada en capacidades', () => {
  ...
  it('el control de que la comprobación anterior NO pasa por vacío', () => {
    ...
    // `expediente/paquete-visita` entra: lee `notas` firmadas para componer y
    // liberar el PaqueteDeVisita (POSTVISIT-001), bajo `clinico.escribir`.
  ...
  it('las rutas que tocan la IDENTIDAD del paciente están congeladas (segundo nivel de PHI)', () => {
    ...
    expect(conPaciente).toEqual([
      ...
      /**
       * Compone y libera el `PaqueteDeVisita` (POSTVISIT-001): lee `patients`
       * para llegar a `notas` y a la config del consultorio. Va con
       * `clinico.escribir` — es el mismo acto que firmar, hacia el paciente.
       */
