...
export const CLINICAL_ENGINE_REGISTRY: MotorClinico[] = [
  ...
  },
  {
    ...
    tipo: 'regla-de-seguridad',
    version: '1.0.0',
    referencia: 'units-and-numbers.json del paquete Ausculta_CLINICAL_ASR_PIPELINE_V1 del Dr. (2026-07-30) y el caso 1 de sus critical-test-cases.json («cero punto quince microgramos por kilo por minuto» -> 0.15 mcg/kg/min). Los nombres hablados salen de ese archivo y del corpus de 498 audios. Sin fuente clinica: es ortografia de cantidades.',
