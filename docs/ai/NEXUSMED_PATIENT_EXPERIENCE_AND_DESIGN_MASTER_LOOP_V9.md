...
| 2026-08-09 | **DESIGN-SLATE-001** | `85abdd8` | Las 9 rutas del paciente sacan su color de un token, con excepciones declaradas una a una · `.spin`/`.nx-pulse`/`.nx-caret` dejan de depender de que otra pantalla esté montada · 6 rellenos con el token del TEXTO (2,95:1 en claro) corregidos, incluido el `Sidebar` | **293, 294, 295** |
