...
**Fuente**: los 83 REG de `docs/audit/regression-ledger.md`.

---

## Por qué contar

El ledger tiene 83 defectos con su causa raíz. Leídos de uno en uno son 83
...
|---|---:|---|
| **Escrito, probado y sin conectar** | **15** | El módulo existe, tiene pruebas y está bien. Simplemente **no corre** en el camino que el médico recorre — o corre con una entrada incompleta |
...
| Nadie lo estaba midiendo | 7 | No es un defecto del producto: es la ausencia del instrumento que lo habría delatado |
...
**«Escrito, probado y sin conectar» — 15 de 83, y el 7-ago-2026 volvió a ser la
familia más grande.**
...
**«El sistema se contradice a sí mismo» — 15 de 83.**
