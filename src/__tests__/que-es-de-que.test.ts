...
describe('el motor existe y está probado; la pantalla ya no lo monta (D-048)', () => {
  ...
  it('la consulta NO lo monta: el dueño no quiere ver de dónde salió (D-048, 10-sep-2026)', () => {
    /**
