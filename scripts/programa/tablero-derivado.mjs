#!/usr/bin/env node
/**
 * EL ESTADO DEL TABLERO SE DERIVA — WS-01, REG-564.
 *
...
/**
 * LAS COMPUERTAS, DERIVADAS — REG-589.
 *
 ...
 *
 * Es la cuarta vez este mes —con REG-572, REG-576 y REG-586— que **la garantía
...
export function generarCompuertas(c = compuertas()) {
  ...
  l.push('> los reescribe y su guardián falla si están viejos. Antes de REG-589 esta sección se')
