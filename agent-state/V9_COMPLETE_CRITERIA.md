...
| 4 | `POSTVISIT-001` | ✅ **cerrada** | `PENDIENTE-SHA` |
...
> `POSTVISIT-GATE-001` y `POSTVISIT-ENTREGA-001` **cerrados** el 10-ago-2026 con
> REG-306 y REG-307. Los dos eran de `POSTVISIT-001` y cerraron con ella.
