 ...
 */
const CACHE = 'nexusmed-v529'  // AUDITORIA MULTI-ESPECIALIDAD lote 1: (1) P0 PEDIATRIA: la verificacion de sobredosis mg/kg estaba MUERTA en la receta (revisarDosis se llamaba sin pesoKg -> solo topes de adulto); ahora usa el peso de la nota si el paciente es <18a. (2) PREOP: pulsar 'Aplicar escalas' sin ninguna escala capturada BORRABA la conclusion/recomendaciones tecleadas a mano (con toast de exito); ahora no toca la nota y avisa. (3) RECORDATORIO WhatsApp nombra al medico de LA CITA (no al titular). (4) CRON de recordatorios cada hora 24/7 (antes tenia hueco nocturno que perdia citas muy temprano/tarde). (5) 'no asistio' ya NO ofrece un horario pasado a la lista de espera (solo huecos futuros). (6) CRM: spinner eterno si fallaba la lectura -> ahora catch/finally. (7) Corte de caja ya no dice 'todo cobrado' en un dia sin consultas. Tests 1275.
