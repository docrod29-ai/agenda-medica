...
| 2026-08-09 | **POSTVISIT-001** | `4eb71bf` | El bucle cierra: el médico libera desde la consulta, el servidor compone de la nota GUARDADA y sella quién y cuándo, el paciente lo lee en su portal. La composición vuelve **con su llamador**. No deduce suspensiones. | **306-309** |
