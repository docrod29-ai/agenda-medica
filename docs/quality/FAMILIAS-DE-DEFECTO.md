...
**Abierto**: 6-ago-2026. **Fuente**: los 62 REG de `docs/audit/regression-ledger.md`.

---

## Por qué contar

El ledger tiene 62 defectos con su causa raíz. Leídos de uno en uno son 57
...
**«Escrito, probado y sin conectar» — 9 de 62, la familia más grande.**
...
**«El sistema se contradice a sí mismo» — 8 de 62.** Ninguna de las dos partes
...
aterrice el REG-215, esta prueba se pone roja hasta que alguien conteste «¿de qué
