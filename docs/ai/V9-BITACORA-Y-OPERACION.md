...
| 2026-08-10 | **POSTVISIT-001** | `77ab367` | El paquete se compone de la nota **firmada**, sólo se libera con aprobación —capacidad `firmar`, aprobador del token, `create` y no `set`— y **llega** al destino «Cuidado» del paciente. Y el fármaco recién suspendido deja de imprimirse como si hubiera que tomarlo | **306, 307** |
