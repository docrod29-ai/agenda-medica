...
export const FAMILIAS: readonly FamiliaDeDefecto[] = [
  ...
  },
  {
     ...
     * comprobar.
     */
    regs: [171, 179, 180, 189, 191, 194, 196, 199, 214, 217, 223, 226, 229, 234, 269, 270, 272, 273, 277, 278, 279, 285, 286, 291, 293, 298, 305, 307, 311, 312, 313, 314, 321, 322, 336, 338, 364, 372, 373, 374, 377, 403, 412, 417, 444, 516, 532],
  },
  {
    clave: 'habla_real',
