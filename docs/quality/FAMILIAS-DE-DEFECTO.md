...
**Abierto**: 6-ago-2026. **Fuente**: los 58 REG de `docs/audit/regression-ledger.md`.

---

## Por qué contar

El ledger tiene 58 defectos con su causa raíz. Leídos de uno en uno son 57
...
| El habla real no cabía en el motor | 7 | El motor cubre el español que uno *escribiría*, no el que se *habla* en un consultorio mexicano |
...
**«Escrito, probado y sin conectar» — 9 de 58, la familia más grande.**
...
**«El sistema se contradice a sí mismo» — 8 de 58.** Ninguna de las dos partes
...
**«Nadie lo estaba midiendo» — 5 de 58**, y cada uno destapó otros al encenderse.
...
aterrice el REG-211, esta prueba se pone roja hasta que alguien conteste «¿de qué
