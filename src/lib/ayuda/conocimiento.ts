...
export const GUIA: SeccionGuia[] = [
  ...
  },
  {
    ...
    pasos: [
      ...
      { t: '¿Cuántas notas alcanzan mis créditos?', d: 'Depende del motor. Ej. con 450 créditos (plan Consulta): ~150 notas Estándar, o 45 Máximas, o una mezcla. Los casos difíciles gastan más porque razonan más.' },
  ...
  },
  {
    ...
    pasos: [
      { t: 'Los planes', d: 'Agenda ($399, sin expediente completo ni IA) · Expediente ($699, expediente completo escrito, sin IA de voz) · Consulta ($1,190, 450 créditos, nota por voz). Pro y Hospital + UCI ya no se venden; quedan para quien los paga.' },
      { t: 'Cobro por médico', d: 'Cada plan incluye 1 médico; cada médico adicional se cobra aparte (Expediente y Consulta +$499, Pro +$999) y trae su propia bolsa de créditos. La asistente no cuenta.' },
