...
export const FAMILIAS: readonly FamiliaDeDefecto[] = [
  {
    ...
    regs: [154, 160, 164, 167, 169, 170, 182, 188, 198, 218, 221, 222, 225, 230, 232, 236, 238, 239, 244, 249, 252, 256, 257, 258, 259, 261, 262, 264, 266, 268, 272],
  },
  {
    clave: 'se_contradice',
  ...
  },
  {
    ...
    patron:
      ...
      'lo demás.',
    regs: [157, 193, 195, 215, 216, 219, 270, 271, 273],
  },
  {
    clave: 'tarde',
