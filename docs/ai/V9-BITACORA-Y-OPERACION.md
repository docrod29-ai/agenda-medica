...
| 2026-08-10 | **POSTVISIT-001** | `83c1fbc` | La composición vuelve con su llamador: `POST /api/paciente/paquete` compone desde la nota FIRMADA, libera con `approvedBy`, y el resumen aparece en `/mi/[token] → Cuidado`. La hoja del médico gana compuerta de firma | **306, 307** |
