...
**Fuente**: los REG de `docs/audit/regression-ledger.md` (263 clasificados hoy).
...
**«Escrito, probado y sin conectar» — 74 de 263, y el 7-ago-2026 volvió a ser la
familia más grande.**
...
**«El sistema se contradice a sí mismo» — 43 de 263.**
...
**«Nadie lo estaba midiendo» — 34 de 263**, y cada uno destapó otros al encenderse.
