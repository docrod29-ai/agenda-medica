...
| Casos declarados en el árbol | **13026** en 1093 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **583 archivos · 7960 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-654** | `docs/audit/regression-ledger.md` |
