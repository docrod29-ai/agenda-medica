...
| 4 | `POSTVISIT-001` | ✅ **cerrada** | `77ab367` |
...
> `POSTVISIT-GATE-001` y `POSTVISIT-ENTREGA-001` se cerraron con REG-307 el
> 10-ago-2026. Quedan tres P1 y un P0.
...
| unit + integration (`npx vitest run`) | ✅ 8 596 casos · 1 fallo de entorno declarado (`ops-timeout`, falla igual con el árbol limpio) |
