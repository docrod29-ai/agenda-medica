 ...
 */
const CACHE = 'nexusmed-v475'  // MODULO 3 — 'configuro los margenes y no sirve'. Los margenes en mm del calibrador se DESCARTABAN en cuanto hubiera un campo colocado: el medico movia Arriba/Abajo, veia moverse el recuadro cian (que se dibuja con esos mismos valores) guardaba, y el impreso no cambiaba. Ahora el autocalculo desde los campos es solo el VALOR POR DEFECTO; si calibraste a mano, ganan los tuyos. Ademas el calibrador avisa cuando los margenes suman mas que la hoja, que es lo que hacia desaparecer los medicamentos del papel.
