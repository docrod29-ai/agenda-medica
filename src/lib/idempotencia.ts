 ...
 */
export type AmbitoIdempotente = 'cobro' | 'nota' | 'laboratorio' | 'lista-espera' | 'adenda' | 'farmacia' | 'arco' | 'foto'

const AMBITOS: readonly AmbitoIdempotente[] = ['cobro', 'nota', 'laboratorio', 'lista-espera', 'adenda', 'farmacia', 'arco', 'foto']
