...
| 2026-08-09 | **`DESIGN-SYSTEM-001` · los cimientos** | `de40cac` | `@theme inline` de 4 a 51 tokens · escalas de espacio, tipografía (por papel), radio (por pieza) y sombra · trinquete de deuda con techo sellado y guardián · azul de marca en una sola forma (98 → 0) | — |
| 2026-08-09 | **`A11Y-GATE-001` · parcial** | *(este commit)* | Cero controles sin nombre en las nueve pantallas del paciente, con detector probado al revés y la superficie declarada en un solo sitio. Reparados 11 campos, 5 botones y 2 regiones vivas. **Falta**: `axe` sobre la app corriendo, contraste en pantalla, foco, objetivo táctil y el panel del médico | — |
