...
**Abierto**: 6-ago-2026. **Actualizado**: 9-sep-2026.
**Fuente**: los REG de `docs/audit/regression-ledger.md` (346 clasificados hoy).
...
**«Escrito, probado y sin conectar» — 132 de 476, y el 7-ago-2026 volvió a ser la
familia más grande.**
...
**«El sistema se contradice a sí mismo» — 60 de 436.**
...
**«Nadie lo estaba midiendo» — 74 de 436**, y cada uno destapó otros al encenderse.
