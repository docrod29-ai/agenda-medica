...
| Casos declarados en el árbol | **13315** en 1123 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **615 archivos · 8334 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-684** | `docs/audit/regression-ledger.md` |
