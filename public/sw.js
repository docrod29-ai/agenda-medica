 ...
 */
const CACHE = 'nexusmed-v481'  // HERRAMIENTAS POR ESPECIALIDAD + BUSCADOR. La consulta mostraba las mismas 8 herramientas a todo el mundo: un internista tenia Gineco y Pediatria ocupando espacio en CADA consulta, y un pediatra calculadoras de riesgo cardiovascular a 10 anios que no usara nunca. Esa saturacion cuesta tiempo — hay que leerlas para descartarlas, en cada paciente. Ahora se muestran las de su especialidad y el resto vive en un BUSCADOR: no desaparece ninguna, y al abrirlas se integran a la nota igual. Las subespecialidades heredan el juego de su TRONCO (infecto, gastro y cardio son internistas antes que subespecialistas). El contexto del paciente gana a la configuracion: si el diagnostico dictado es una hernia, el panel de cirugia aparece aunque seas internista. Un test cazo que 'ne-UROLOGIA' casaba 'urologia' y mandaba a los neurologos a cirugia.
