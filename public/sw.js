 ...
 */
const CACHE = 'nexusmed-v490'  // LOTE FINANZAS: 3 defectos de dinero. (1) ANULAR UN COBRO SIN RASTRO: las reglas congelaban el monto pero dejaban 'cancelado' libre, asi que cualquier miembro de cualquier rol podia poner cancelado:true desde la consola, sin motivo ni autor, y el cobro desaparecia de todos los cortes — sustraccion de efectivo indetectable en un archivo que se dice anti-fraude. Ahora anular exige autor (== tu propio uid), fecha y motivo no vacio, y no permite tocar nada mas; ademas Finanzas ESTRENA una tarjeta de cobros anulados para que dejen de ser invisibles. (2) ABONO PARCIAL DABA LA CONSULTA POR COBRADA AL 100%: abonar 200 de una consulta de 800 la sacaba de cuentas por cobrar y los 600 se perdian; ahora un abono no salda la cita (sigue pendiente hasta el cobro de cierre) pero su dinero si cuenta como ingresado. (3) UN FALLO DE TARJETA SUSPENDIA LA CLINICA AL PRIMER INTENTO: Stripe manda payment_failed/past_due en el primer rechazo del ciclo y reintenta por dias, pero se cortaba el acceso a TODOS los expedientes ese mismo dia — pierde acceso pagando. Ahora durante el dunning se conserva el acceso, solo corta unpaid/canceled, y invoice.paid REACTIVA una clinica que estuviera suspendida.
