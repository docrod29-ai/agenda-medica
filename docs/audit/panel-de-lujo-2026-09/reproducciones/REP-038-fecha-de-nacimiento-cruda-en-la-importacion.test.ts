/**
 * REP-038 · ASE-003 (AS-expedientes) — el importador guarda la fecha de
...
describe('REP-038 · «15/03/1980» se entiende como 1980-03-15 antes de escribirse', () => {
  ...
  it('HOY FALLA: «15/03/1980» (Excel es-MX) se normaliza a 1980-03-15 por alguna de las tres vías', () => {
  ...
  it('HOY FALLA: con esa fecha la edad se deriva (46 al 2026-09-06)', () => {
    const n = normalizar('15/03/1980')
    expect(edadEnAnios(n?.iso ?? '15/03/1980', '2026-09-06')).toBe(46)
  })

  it('HOY FALLA: el importado («15/03/1980») y el capturado a mano («1980-03-15») son la MISMA persona', () => {
    const n = normalizar('15/03/1980')
