...
describe('E0-07 · el registro no puede MENTIR sobre el código (por MÉTODO y por ARGUMENTO)', () => {
  ...
  it('el ANALIZADOR no pasa por vacío (si se rompe, todo lo de arriba pasaría sin comprobar nada)', () => {
    ...
    // abierto.
    expect(llamadas.length).toBe(101)   // +2 el 2026-09-06: `pacientes/fundir` (ASE-009) y `arco/ligar` (ASE-010), una llamada y un POST cada una.   // +1 el 2026-09-05 (REG-523): `expediente/pregunta-atendida`;   // +2 el 2026-08-27 (POSTVISIT-001): `expediente/paquete-de-visita` y la rama `clinico` de `portal/link`;   // +1 el 2026-08-04: `arco/oponerse`; +1: `superadmin/incidentes`; +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    expect(rutasConGuardia).toBe(83)   // +2 el 2026-09-06: `pacientes/fundir` y `arco/ligar`, cada una con su propio `verificarCapacidad`   // +1 el 2026-09-05 (REG-523): `expediente/pregunta-atendida`   // +1 el 2026-08-27: `expediente/paquete-de-visita`   // +1 el 2026-08-04: `arco/oponerse`   // +1: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    ...
    expect(conVocabulario).toBe(58)   // +2 el 2026-09-06: `pacientes/fundir` y `arco/ligar` ('administrar' como literal las dos)   // +1 el 2026-09-05 (REG-523): `expediente/pregunta-atendida`   // +2 el 2026-08-27 (POSTVISIT-001)   // +1 el 2026-08-04: `arco/oponerse`; +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
  })
