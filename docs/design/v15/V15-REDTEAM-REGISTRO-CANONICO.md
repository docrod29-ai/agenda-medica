...
| RTC-14 | **P1** (era P2) | RT-10 + ORT-11 + medición 14-ago | **CONFIRMADO Y MEDIDO por fin.** Estuvo sin medir desde el panel porque ningún paciente de la siembra tenía alergias ni notas: en el navegador la pantalla salía siempre vacía. Con historia sembrada (14-ago) se cuenta sola. `/consulta`: la alergia se pinta **×2 en el primer pliegue** (49px) — la franja EDITABLE de arriba y una píldora de sólo lectura bajo el nombre, que enseña los alérgenos ya interpretados. `/expediente`: ×1, esa mitad ya estaba pagada. **Y un hallazgo que el pliegue vacío escondía**: con historia, la identidad del paciente cae a **287px en escritorio y 404px en móvil** (con las cajas de alergias, problemas y visitas anteriores por delante), y «Grabar la consulta» a 452/564px — el trabajo de la pantalla, en el tercio inferior del teléfono | UNA presentación, y la decisión NO es de estilo: una es editable (el médico registra la alergia durante la consulta) y la otra enseña la lectura semántica (`alergenosDe`, REG-279/REG-311). Hay que conservar las dos capacidades en un solo sitio. Y la identidad tiene que volver a encabezar (§5/§7). Acta: `docs/design/capturas/v15-rtc14/medicion.json` |
