...
describe('E0-07 · el registro no puede MENTIR sobre el código (por MÉTODO y por ARGUMENTO)', () => {
  ...
  it('el ANALIZADOR no pasa por vacío (si se rompe, todo lo de arriba pasaría sin comprobar nada)', () => {
    ...
    // abierto.
    expect(llamadas.length).toBe(100)   // +2 el 2026-08-31 (REG-580): `whatsapp/no-entregados` cobra `mensajeria.enviar` en GET y en POST — la misma puerta que `/entregas`, porque la cola lleva teléfonos y textos de pacientes y verla no es más inocente que usarla.   // +2 el 2026-08-27 (POSTVISIT-001): `expediente/paquete-de-visita` (verificarCapacidad 'firmar') y la rama `clinico` de `portal/link`, que cobra `firmar` para emitir un enlace con secreto médico dentro;   // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    expect(rutasConGuardia).toBe(81)   // +1 el 2026-08-31: `whatsapp/no-entregados` (REG-580)   // +1 el 2026-08-27: `expediente/paquete-de-visita`   // +1 el 2026-08-04: `arco/oponerse`   // +1 el 2026-08-04: `superadmin/incidentes`   // +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
    ...
    expect(conVocabulario).toBe(57)   // +2 el 2026-08-31 (REG-580): los dos métodos de `whatsapp/no-entregados`   // +2 el 2026-08-27 (POSTVISIT-001): `expediente/paquete-de-visita` y la rama `clinico` de `portal/link`   // +1 el 2026-08-04: `arco/oponerse`; +1 el 2026-08-03: `clinic/exportar-excel`; +1 el 2026-08-02: `calendar/ocupado`; +1 `seguridad/csp-estado`
  })
