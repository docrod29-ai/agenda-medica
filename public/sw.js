 ...
 */
const CACHE = 'nexusmed-v484'  // EL MOTOR DE CALCULO AUTOMATICO ESTABA DESCONECTADO. El copiloto ya sabia calcular solo, sin pedir nada: TFG por CKD-EPI 2021, FIB-4, ajuste renal de farmacos, PREVENT y metas lipidicas — todo escrito y con pruebas. Pero la consulta NUNCA le pasaba los laboratorios (un grep de 'labs' en esa pantalla devolvia CERO), asi que todo eso estaba muerto: el unico calculo automatico vivo era el IMC. El medico no veia la TFG de su paciente y encima acababa tecleando a mano escalas que el sistema ya sabia calcular. Ahora los estudios del dictado —que el NER ya extraia con valor y unidad— se traducen al vocabulario del copiloto. El mapeo es CONSERVADOR a proposito: no toma la creatinina en orina como serica, no confunde hemoglobina con hemoglobina glucosilada, descarta valores fuera de rango plausible (suelen ser otra unidad) y ante la duda NO mapea — estos numeros alimentan formulas que producen conducta.
