...
| Casos declarados en el árbol | **13361** en 1125 archivos | `node scripts/agent-state/actualizar.mjs` |
| Sellado clínico | **617 archivos · 8380 casos**, no pueden encoger | `npx vitest run src/__tests__/clinical-safety-gate.test.ts` |
| Trinquete de diseño | 9 métricas, todas al techo | `node scripts/design/trinquete-de-diseno.mjs` |
| Última reparación en el ledger | **REG-689** | `docs/audit/regression-ledger.md` |
