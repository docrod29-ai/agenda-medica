 ...
 */
const CACHE = 'nexusmed-v477'  // MODULO 5 — correcciones CLINICAS indicadas por el Dr. (1) MDR/Magiorakos ya NO cuenta la resistencia INTRINSECA: un Proteus mirabilis completamente sensible salia MDR confirmado porque el panel reporta sus 4 resistencias naturales; aplica a toda especie con patron intrinseco. (2) P. aeruginosa con imipenem R + meropenem R pero cefalosporinas S ya no pasa en SILENCIO: se atribuye a porina OprD + bombas de expulsion MexAB-OprM, no a carbapenemasa (una carbapenemasa arrastraria tambien las cefalosporinas). (3) OXACILINA en coagulasa-negativo: corte propio 0.25/0.5 en vez del de S. aureus — con el viejo, un S. epidermidis con CMI 1 salia SENSIBLE, y ~80% portan mecA. (4) DAPTOMICINA en E. faecium: solo SDD <=4, nunca S, y el modulo Gram+ dejo de usar el umbral de estafilococo. (5) Carbapenemasas: KPC y OXA-48 -> CAZ-AVI; IMP/NDM/VIM -> aztreonam, casi siempre con serina coproducida, de ahi la combinacion con avibactam. Se suavizo el 'EXCLUYE'. VERIFICADO y sin cambio: pip-tazo Pseudomonas (R>=64, CLSI 2023) y minociclina Acinetobacter (S<=1/R>=4, CLSI M100-Ed35 2025) ya estaban correctos.
