...
export type AuditEvento =
  ...
  | 'paquete_visita_liberado'    // el médico le entregó al paciente el resumen de su consulta
...
export const EVENTO_LABEL: Record<AuditEvento, string> = {
  ...
  // Liberar es un acto propio, distinto de firmar la nota: dice qué se le
  // ENTREGÓ al paciente y cuándo, que es lo que se pregunta cuando alguien
  // discute si estaba informado.
  paquete_visita_liberado: 'Entregó al paciente el resumen de su consulta',
}
