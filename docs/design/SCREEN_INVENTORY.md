...
| `/chat` | medico | ✅ | 364 | 0 | — | ✅ | — |
| `/citas` | medico | ✅ | 1277 | 6 | — | ✅ | — |
| `/configuracion` | medico | ✅ | 2813 | 1 | — | ✅ | — |
| `/consulta/[patientId]` | medico | ✅ | 8280 | 8 | — | ✅ | ✅ |
| `/consultor` | medico | ✅ | 367 | 0 | — | ✅ | — |
...
| `/expediente/[patientId]` | medico | ✅ | 1273 | 15 | — | ✅ | — |
| `/expedientes` | medico | ✅ | 18 | 1 | — | — | — |
| `/farmacia` | medico | ✅ | 888 | 0 | — | ✅ | — |
| `/finanzas` | medico | ✅ | 758 | 0 | — | ✅ | — |
| `/guia` | medico | ✅ | 143 | 0 | — | ✅ | — |
| `/lista-espera` | medico | ✅ | 309 | 0 | — | ✅ | — |
| `/membresias` | medico | ✅ | 325 | 0 | — | ✅ | — |
| `/migracion` | medico | ✅ | 682 | 1 | — | ✅ | — |
| `/motores` | medico | ✅ | 208 | 0 | — | ✅ | — |
| `/nota/[patientId]` | medico | ✅ | 82 | 2 | — | ✅ | — |
| `/nota/[patientId]/[notaId]` | medico | ✅ | 1050 | 2 | — | ✅ | — |
| `/operaciones` | medico | ✅ | 569 | 1 | — | ✅ | — |
| `/orden/[patientId]/[notaId]` | medico | ✅ | 1039 | 3 | — | ✅ | — |
| `/pacientes` | medico | ✅ | 1457 | 4 | — | ✅ | — |
| `/pendientes` | medico | ✅ | 791 | 3 | — | ✅ | ✅ |
| `/reactivacion` | medico | ✅ | 365 | 0 | — | ✅ | — |
| `/receta/[patientId]/[notaId]` | medico | ✅ | 1310 | 3 | — | ✅ | — |
| `/referencia/[patientId]` | medico | ✅ | 396 | 0 | — | ✅ | — |
| `/resenas` | medico | ✅ | 105 | 0 | — | ✅ | — |
| `/hospitalizacion` | alpha | ✅ | 453 | 5 | — | ✅ | — |
| `/hospitalizacion/[internamientoId]` | alpha | ✅ | 1734 | 4 | — | ✅ | ✅ |
| `/hospitalizacion/camas` | alpha | ✅ | 267 | 1 | — | ✅ | — |
| `/hospitalizacion/indicadores` | alpha | ✅ | 130 | 0 | — | ✅ | — |
