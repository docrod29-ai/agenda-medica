...
export const EMBARAZO_LACTANCIA: RiesgoGestacional[] = [
  ...
  { farmaco: 'Ácido valproico', sinonimos: ['valproato','valproato de magnesio','valproato de sodio','valproato semisodico','valproato semisódico','divalproato','divalproex','acido valproico','ácido valproico'], embarazo: 'contraindicado', lactancia: 'precaucion', motivo: 'Defectos del tubo neural y afectación del neurodesarrollo. Evitar en toda mujer en edad fértil sin anticoncepción.', alternativa: 'Lamotrigina o levetiracetam, según la indicación.' },
  { farmaco: 'Metotrexato', sinonimos: ['metotrexate','metrotexato','methotrexate','mtx'], embarazo: 'contraindicado', lactancia: 'evitar', motivo: 'Abortivo y teratógeno. Suspender al menos 3 meses antes de buscar embarazo.' },
