...
export const CLINICAL_ENGINE_REGISTRY: MotorClinico[] = [
  ...
  },
  {
    ...
    /** REG-528: la misma sustancia en varios renglones se suma contra el MISMO catálogo. */
    archivos: ['src/lib/seguridad/terapia-duplicada.ts'],
    entryPoints: ['revisarDosis', 'CATALOGO', 'buscarFarmaco', 'terapiaDuplicadaDeLaLista'],
    calculos: ['detección de error de decimal (50 → 500 mg)', 'zona amarilla entre máximo habitual y absoluto', 'topes por vía y edad mínima', 'terapia duplicada: misma sustancia (nombre o alias del CATALOGO) en dos renglones o ya vigente, con la dosis diaria acumulada contra el techo del catálogo (REG-528)'],
