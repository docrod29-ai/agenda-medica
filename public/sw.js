 ...
 */
const CACHE = 'nexusmed-v472'  // MODULO 2 — los 3 pendientes que quedaban. (1) La oferta de un hueco de lista de espera se podia PERDER EN SILENCIO: waitlist-notify creaba la sesion del bot con id automatico mientras el resto del sistema usa un id derivado del telefono; con dos sesiones para el mismo numero, el limit(1) podia devolver la que no era, el 'SI' del paciente caia al menu por defecto y nadie ocupaba el horario. (2) El booking publico interpretaba la fecha en la zona del SERVIDOR (UTC en Vercel), 6h antes del instante real: bomba de tiempo para el dia que se habilite reservar el mismo dia. (3) Un enlace ?id= a una cita mas antigua que la ventana no abria nada y no avisaba: parecia roto.
