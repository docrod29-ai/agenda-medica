...
**Unidad actual**: `POSTVISIT-001` ✅ **CERRADA** (9-ago, REG-306) →
**`PATIENT-AI-001`**. Cerradas antes: `PATIENT-UX-TRUTH-001`, los tres P0 de
audio, `DESIGN-SYSTEM-001`, `NAVIGATION-001` y `PATIENT-COMPANION-001`.
