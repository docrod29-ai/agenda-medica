...
export const FAMILIAS: readonly FamiliaDeDefecto[] = [
  {
    ...
    regs: [154, 160, 164, 167, 169, 170, 182, 188, 198, 218, 221, 222, 225, 230, 232, 236, 238, 239, 244, 249, 252, 256, 257, 258, 259, 261, 262, 264],
  },
  {
    clave: 'se_contradice',
  ...
  },
  {
    ...
    regs: [159, 166, 168, 185, 197, 213, 235, 237, 240, 245, 246, 247, 248, 254, 255, 260, 263, 265],
  },
  {
