...
| Registro de regresiones | `docs/audit/regression-ledger.md` — **55 REG** con causa raíz |
| Invariantes sellados | **232 archivos, 3583 casos** que no pueden encoger |
| Suite completa | **7274 pruebas** en verde, en CI |
...
✅ El `regression-ledger` **es** el historial: 55 defectos con su causa raíz, su
reparación y su prueba de regresión permanente.

**Es un activo, no un pasivo.** Un comprador que ve 55 defectos documentados con
...
**Fuerte**: seguridad documentada, aislamiento probado en CI, 7274 pruebas,
